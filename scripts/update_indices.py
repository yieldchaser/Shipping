...
INDEXES = {
    'BDTI': 'data/indices/dirtytanker_historical.csv',
    'BCTI': 'data/indices/cleantanker_historical.csv',
    'BCI': 'data/indices/cape_historical.csv',
    'BPI': 'data/indices/panama_historical.csv',
    'BSI': 'data/indices/suprama_historical.csv',
    'BHI': 'data/indices/handysize_historical.csv',
...
SOLACTIVE_INDEXES = {
    'DE000SLA4BY3': 'data/futures/bdryff_history.csv',  # Breakwave Dry Freight Futures
    'DE000SL0HLG3': 'data/futures/bwetff_history.csv',  # Breakwave Wet Freight Futures
}
...
AMPLIFY_ETFS = {
    'BDRY': 'data/etf/BDRY_Daily.csv',
    'BWET': 'data/etf/BWET_Daily.csv',
}
...
SGX_PRODUCTS = {
    'CWF': 'data/futures/sgx_cape_futures.csv',
    'PWF': 'data/futures/sgx_panamax_futures.csv',
    'SWF': 'data/futures/sgx_supramax_futures.csv',
    'HWF': 'data/futures/sgx_handysize_futures.csv',
}
