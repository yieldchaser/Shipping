...
def find_producing_script(rel_path):
    ...
    PIPELINE_MAP = {
        ...
        "data/indices/capital_link_container_clci.csv": ("scripts/scrapers/fetch_capital_link_indices.py", "Capital Link Shipping Indices", "https://capitallinkshipping.com", "Web Scraping", "Index"),
        "data/indices/capital_link_drybulk_cldbi.csv": ("scripts/scrapers/fetch_capital_link_indices.py", "Capital Link Shipping Indices", "https://capitallinkshipping.com", "Web Scraping", "Index"),
        "data/indices/capital_link_lng_lpg_cllg.csv": ("scripts/scrapers/fetch_capital_link_indices.py", "Capital Link Shipping Indices", "https://capitallinkshipping.com", "Web Scraping", "Index"),
        "data/indices/capital_link_maritime_clmi.csv": ("scripts/scrapers/fetch_capital_link_indices.py", "Capital Link Shipping Indices", "https://capitallinkshipping.com", "Web Scraping", "Index"),
        "data/indices/capital_link_mixed_fleet_clmfi.csv": ("scripts/scrapers/fetch_capital_link_indices.py", "Capital Link Shipping Indices", "https://capitallinkshipping.com", "Web Scraping", "Index"),
        "data/indices/capital_link_mlp_clmlp.csv": ("scripts/scrapers/fetch_capital_link_indices.py", "Capital Link Shipping Indices", "https://capitallinkshipping.com", "Web Scraping", "Index"),
        "data/indices/capital_link_tanker_clti.csv": ("scripts/scrapers/fetch_capital_link_indices.py", "Capital Link Shipping Indices", "https://capitallinkshipping.com", "Web Scraping", "Index"),
