...
def main():
    ...
    coverage_catalog = [
        ...
        {"node": "Bauxite / Alumina", "group": "Ores and Rocks", "status": "LIVE_MIRROR", "source": "UN Comtrade China Mirror (HS 260600) + Broker Fixtures (Conakry direct series unpublished)", "fixtures": by_commodity["Bauxite"]["fixture_count"] + by_commodity["Alumina"]["fixture_count"], "has_national": True},
