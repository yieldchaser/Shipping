...
TARGET_ETFS = {
    'BDRY': 'data/etf/bdry_holdings.csv',
    'BWET': 'data/etf/bwet_holdings.csv'
}
...
def fetch_etf_prices():
    ...
    try:
        ...
        if not bdry_hist.empty:
            ...
            bdry_csv.to_csv('data/etf/bdry_liquidity.csv', index=False)
            print("Successfully saved data/etf/bdry_liquidity.csv")
        else:
        ...
        if not bwet_hist.empty:
            ...
            bwet_csv.to_csv('data/etf/bwet_liquidity.csv', index=False)
            print("Successfully saved data/etf/bwet_liquidity.csv")
        else:
