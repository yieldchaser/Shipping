...
- steel
date: '2023-07-06'
doc_id: breakwave_insights_insights_2023-07-06_2023_07_06_chinas_housing_market_remains_weak_but_steel_output_is_at_le
...
source_path: reports/breakwave/2023/2023-07-06_chinas-housing-market-remains-weak-but-steel-output-is-at-le.html
source_stem: 2023-07-06_chinas-housing-market-remains-weak-but-steel-output-is-at-le
source_url: https://www.breakwaveadvisors.com/insights/2023/7/6/chinas-housing-market-remains-weak-but-steel-output-is-at-least-improving
summary: 'Main

  By Jeffrey Landsberg

  As we have been stressing in Commodore''s Weekly Dry Bulk Reports, China''s consumer
  recovery remains underway and we expect that its industrial recovery will resume
  this quarter. The housing market is set to remain a significant problem however.
  China''s housing supply has continued to decline by a small amount - but compared
  to the end of the last several years, current floor space still marks the largest
  amount available since 2016.'
themes:
- china
- crude_oil
- steel
...
- prices
- production
title: Chinas Housing Market Remains Weak But Steel Output Is At Least Improving
vessel_classes:
- capesize
- panamax
- supramax
