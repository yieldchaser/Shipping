...
- steel
date: '2023-05-12'
doc_id: breakwave_insights_insights_2023-05-12_2023_05_12_shipfix_global_market_update
...
source_path: reports/breakwave/2023/2023-05-12_shipfix-global-market-update.html
source_stem: 2023-05-12_shipfix-global-market-update
source_url: https://www.breakwaveadvisors.com/insights/2023/5/12/shipfix-global-market-update
summary: 'Main
  ...
  In a further sign that the past year''s interest rate hikes by the Federal Reserve
  are starting to have an effect, the annual US inflation rate fell below five per
  cent for the first time in two years. Consumer prices rose by 4.9 per cent in April
  compared to the same month last year, marginally less than the 5.0 per cent expected
  by the market. The lower-than-expected reading will provide the US central bank
  with more room for manoeuvre as it has to manage concerns over the stability of
  the banking sector and a potential US default should an agreement over the debt
  ceiling not be reached.'
themes:
- capesize
- panamax
- supramax
