...
- gas
date: '2022-07-27'
doc_id: breakwave_insights_insights_2022-07-27_2022_07_27_july_sees_a_boost_of_seaborne_crude_diesel_and_gasoline_supp
...
source_path: reports/breakwave/2022/2022-07-27_july-sees-a-boost-of-seaborne-crude-diesel-and-gasoline-supp.html
source_stem: 2022-07-27_july-sees-a-boost-of-seaborne-crude-diesel-and-gasoline-supp
source_url: https://www.breakwaveadvisors.com/insights/2022/7/27/july-sees-a-boost-of-seaborne-crude-diesel-and-gasoline-supplies
summary: 'Main

  By David Wech

  WTI futures hit a fresh three month low of around $95/b on 22 July, a hefty $25/b
  lower than at the end of last month. Soaring inflation amid a global energy crisis
  turned recession fears from a downside scenario into a base-case assumption, at
  least amongst a wide set of market participants. In line with that, demand expectations
  were curtailed and oil prices came under pressure together with many other indices.'
themes:
- china
- europe
- crude_oil
...
- gas
- crude
title: July Sees A Boost Of Seaborne Crude Diesel And Gasoline Supplies
vessel_classes:
- capesize
- panamax
- supramax
...
In spite of solid crude supplies from Saudi Arabia, the UAE and the US, as well as likely seasonally and refinery-margin-induced lower refinery run levels in the coming months, there are still various bullish supporting factors at hand, including the following:
Over the last seven weeks global onshore crude inventories (excl. US SPR) have been drawn by 2mbd , 0.6kbd of which materialised in China. Evidently crude supplies have been falling behind demand levels, which is not unusual for the summer period, but still meaningful.
This is related to crude liftings from all other countries (excl. Saudi Arabia, UAE and US) falling again steadily over recent months, driven by Africa. But essentially all supplying regions are below their 2019 average, by a combined 3.5mbd. The peak supply loss, early in the Covid era, was about 5mbd - highlighting that current supplies are much closer to these lows than to the 2019 average.
Chinese imports of crude (and all other hydrocarbons) have been very disappointing so far this year. At some point of time, a trend reversal is likely to happen, given recent stockdraws. However, the recovery may not be as healthy as many expected just a couple of months back.
Supply-side risks are omnipresent. We have already seen substantial outages so far this year from multiple countries. Not only is the US hurricane season starting now, but more importantly Russian oil supply dynamics have yet to change. Over June and July, 6.4mbd of Russian seaborne oil is set to arrive around the world, equal to the level over January and February, and some 300kbd more than the 2020-21 average. After Russia has already cut its piped gas exports to Europe down to a trickle, oil exports could follow suit, e.g. in reaction to the proposed price cap by G7. Exports of Kazakh oil via Russia could be an easy first victim of Kremlin retaliation.
Global crude liftings, excl. Saudi Arabia, United Arab Emirates and United States vs 2019 average (mbd)
Data Source: Vortexa