...
- gas
date: '2022-06-02'
doc_id: breakwave_insights_insights_2022-06-02_2022_06_02_indonesia_and_russia_remain_chinas_primary_sources_of_coal_i
...
source_path: reports/breakwave/2022/2022-06-02_indonesia-and-russia-remain-chinas-primary-sources-of-coal-i.html
source_stem: 2022-06-02_indonesia-and-russia-remain-chinas-primary-sources-of-coal-i
source_url: https://www.breakwaveadvisors.com/insights/2022/6/2/indonesia-and-russia-remain-chinas-primary-sources-of-coal-imports
summary: 'Main

  By Jeffrey Landsberg

  China''s April coal import data by origin was recently released and shows that imports
  from Indonesia have remained the primary source of imports and Russia the second
  largest source of imports. Imports from Indonesia totaled 16 million tons, which
  is up from March by 6 million tons (60%) and up year-on-year by 4.3 million tons
  (37%). Imports from Russia totaled 3.9 million tons, which is up from March by 800,000
  tons (26%) but down year-on-year by 600,000 tons (-13%).'
themes:
- china
- australia
- coal
...
- imports
- march
title: Indonesia And Russia Remain Chinas Primary Sources Of Coal Imports
vessel_classes:
- capesize
- panamax
- supramax
