...
- gas
date: '2022-10-11'
doc_id: breakwave_insights_insights_2022-10-11_2022_10_11_indonesia_and_russia_continue_to_contribute_to_majority_of_c
...
source_path: reports/breakwave/2022/2022-10-11_indonesia-and-russia-continue-to-contribute-to-majority-of-c.html
source_stem: 2022-10-11_indonesia-and-russia-continue-to-contribute-to-majority-of-c
source_url: https://www.breakwaveadvisors.com/insights/2022/10/11/indonesia-and-russia-continue-to-contribute-to-majority-of-chinas-coal-imports
summary: 'Main

  By Jeffrey Landsberg

  China''s coal import data for August by origin was recently released and showed
  that imports from Indonesia have remained China''s primary source and Russia the
  second largest source. Imports from Indonesia totaled 15.8 million tons, which is
  up from July by 4.1 million tons (35%) but down year-on-year by 1.6 million tons
  (-9%). Imports from Russia totaled 8.5 million tons, which is up from July by 1.1
  million tons (15%) and up year-on-year by 3.1 million tons (57%).'
themes:
- china
- australia
- coal
...
- million
- tons
title: Indonesia And Russia Continue To Contribute To Majority Of Chinas Coal Imports
vessel_classes:
- capesize
- panamax
- supramax
