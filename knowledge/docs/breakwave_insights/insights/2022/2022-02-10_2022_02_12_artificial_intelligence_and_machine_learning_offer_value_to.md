...
- gas
date: '2022-02-10'
doc_id: breakwave_insights_insights_2022-02-10_2022_02_12_artificial_intelligence_and_machine_learning_offer_value_to
...
source_path: reports/breakwave/2022/2022-02-12_artificial-intelligence-and-machine-learning-offer-value-to.html
source_stem: 2022-02-12_artificial-intelligence-and-machine-learning-offer-value-to
source_url: https://www.breakwaveadvisors.com/insights/2022/2/10/artificial-intelligence-and-machine-learning-offer-value-to-the-shipping-community
summary: 'Main

  By Mike Konstantinidis

  The shipping industry is at a time of major change, having to deal with issues that
  are mainly relevant to the regulatory framework, while ship-owning and ship-management
  companies as well as charterers are required to make important decisions about their
  model of operation and strategic decisions on their business activity and investments.
  The optimization of environmental footprint of the cargo vessels becomes more and
  more pressing through ever increasing stricter regulatory obligations. The development,
  however, which is revolutionizing the maritime sector has to do with the exploitation
  of all those data produced onboard the vessels and the extraction of the actionable
  intelligence that is hidden inside them.'
themes:
- data
- learning
- significant
...
- machine
- maritime
title: Artificial Intelligence And Machine Learning Offer Value To The Shipping Community
vessel_classes:
- capesize
- panamax
- supramax
