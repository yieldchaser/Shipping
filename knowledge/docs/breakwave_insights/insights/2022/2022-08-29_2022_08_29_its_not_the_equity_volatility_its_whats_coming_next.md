...
- gas
date: '2022-08-29'
doc_id: breakwave_insights_insights_2022-08-29_2022_08_29_its_not_the_equity_volatility_its_whats_coming_next
...
source_path: reports/breakwave/2022/2022-08-29_its-not-the-equity-volatility-its-whats-coming-next.html
source_stem: 2022-08-29_its-not-the-equity-volatility-its-whats-coming-next
source_url: https://www.breakwaveadvisors.com/insights/2022/8/29/its-not-the-equity-volatility-its-whats-coming-next
summary: 'Main

  By George Lagarias

  A lot can happen in eight minutes. You can read eight pages of a novel. You can
  wait for the sun''s light to reach you.'
themes:
- crude_oil
- not
- are
...
Main
By George Lagarias
A lot can happen in eight minutes. You can read eight pages of a novel. You can wait for the sun's light to reach you.
...
None of this comes as a surprise. We are in a bear market and volatility is to be expected. Inflation is so high and markets have learned to over-dissect every world the Fed says, that inconsistencies and policy uncertainty are also to be expected.
...
We are honestly less worried about equity volatility and more worried about the long-term implications of the Fed's approach. Sharply raising interest rates might not work as fast or efficiently as they may believe. It's playbook, was written at an era when the world's foremost economy was a lot more closed. Trade as a percentage of GDP was 35% in the early eighties. Now, even after a dramatic fall during the trade wars and the pandemic, it is over 52%. A more open economy means that reducing local demand will have a smaller impact on inflation. So, demand would have to be reduced significantly, before it has an impact on the things that bring inflation up, namely energy. People would have to stop ordering goods, for example, so trucks won't have to move to deliver them and factory lines can go slower, consuming less energy. For demand to drop, people will need to see their income curtailed and credit availability slashed. Given that consumers have not been prone to spending excesses in the past years (anyone remember ‘secular stagnation'?), there simply isn't that much fat to burn.
Meanwhile, the Dollar is getting so strong, that the US trade deficit is widening substantially. Meanwhile, Emerging Markets, a lot of which have Dollar-denominated debt, are suffering. We are already seeing significant dislocations in Asian bond markets.
What we are worried more about, however, is that the Fed's main aim, to maintain its credibility as an inflation-fighting machine, and therefore its vaunted independence, may not be achieved by engineering a recession. We come into this new crisis, not after an era of plenty, but after an era of consumer deleveraging and re-regulated banks.
When prices eventually stop rising, the recession could go deep and inflation could quickly turn into deflation. Politicians will be calling ‘policy error' and blaming everything on central banks. It isn't difficult to see how we get there. For fourteen years, central banks were unchecked in printing money in a closed system, that helped financial markets, but led to misallocations in the real economy and a sharp rise in income inequality. Add a recession, and the stated belief that people should be prevented from going to their bosses for a raise, and it's not hard to see the bull's eye painted on the back of central banks. Central banks may look to markets and banks for help, but what they will find is a pack of starving and disorientated Pavlov's dogs looking back at them. Abandoning years of accurate policy guidance may do that to investors.
UK PM hopeful Lis Truss has already said it wants to revisit the Bank of England's mandate. We wouldn't be too surprised if this becomes a trend, and central bank independence is questioned.
