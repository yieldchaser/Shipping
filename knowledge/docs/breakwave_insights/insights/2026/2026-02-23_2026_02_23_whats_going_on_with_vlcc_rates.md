...
- gas
date: '2026-02-23'
doc_id: breakwave_insights_insights_2026-02-23_2026_02_23_whats_going_on_with_vlcc_rates
...
- section: Main
  section_type: null
  source_line: According to Breakwave Advisors, VLCC rates climbed sharply in late
    January and have remained near multi-year highs. The Baltic Dirty Tanker Index
    is trading about 90% above the same period last year, reflecting how strong freight
    remains compared with histori
  unit: pct
  values:
  - 90.0
- section: Main
  section_type: null
  source_line: Arctic Securities supports the idea that the market isn't just reacting
    to fleeting demand spikes. They have lifted their 2026 VLCC forecasts significantly,
    pointing to sustained structural tightness and continued elevated spot rate levels.
    They argue that eve
  unit: null
  values:
  - 2026.0
...
source_path: reports/breakwave/2026/2026-02-23_whats-going-on-with-vlcc-rates.html
source_stem: 2026-02-23_whats-going-on-with-vlcc-rates
source_url: https://www.breakwaveadvisors.com/insights/2026/2/23/whats-going-on-with-vlcc-rates
summary: 'Main

  By Panagiota Kinti

  VLCC freight rates have surged to levels not seen in years, surprising many market
  participants and prompting fresh debate across the tanker market. What at first
  looked like an ordinary recovery has developed into a pronounced spike driven by
  a combination of supply tightness, geopolitical risk and structural market shifts.
  According to Breakwave Advisors, VLCC rates climbed sharply in late January and
  have remained near multi-year highs.'
themes:
- vlcc
- china
- meg
...
- crude
- geopolitical
title: What's Going on with VLCC Rates?
vessel_classes:
- capesize
- panamax
- supramax
