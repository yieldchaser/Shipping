...
- steel
date: '2026-01-21'
doc_id: breakwave_insights_insights_2026-01-21_2026_01_21_china_has_started_2026_with_two_signals_that_matter_for_bulk_shipping
...
- section: Main
  ...
  source_line: China has started 2026 with two signals that matter for bulk shipping
    in different ways. One is policy-driven and hits steel trade flows directly. The
    other is balance-sheet driven and shows up first in iron ore restocking behaviour.
  unit: null
  values:
  - 2026.0
- section: Main
  section_type: null
  source_line: On the steel side, the introduction of export licensing from 1 January
    2026 marks a clear change in how outbound steel trade is managed. A broad range
    of products across the steel value chain now require shipment-specific approval,
    supported by export contract
  unit: null
  values:
  - 1.0
  - 2026.0
...
- section: Main
  section_type: null
  source_line: For dry bulk, the exposure is most acute in the smaller geared segments.
    The bulk of seaborne steel moves on geared vessels, with Supramax accounting for
    the largest share. Any moderation in export volumes disproportionately affects
    backhaul demand out of Chin
  unit: null
  values:
  - 2025.0
- section: Main
  section_type: null
  source_line: Iron ore presents a different dynamic. Here, the near-term signal is
    inventory. Portside stocks have climbed to around 155 million tonnes, close to
    historic highs and near the levels last seen during the 2018 peak. High port inventories
    do not automatically me
  unit: pct
  values:
  - 155.0
  - 2018.0
...
- section: Main
  section_type: null
  source_line: Netting it out, 2026 starts with softer visibility for Supramax/ Handy
    steel-export demand because policy is adding friction exactly where volumes had
    been doing the heavy lifting. For Capes, the call hinges on whether elevated port
    stocks translate into a sus
  unit: null
  values:
  - 2026.0
regions:
...
source_path: reports/breakwave/2026/2026-01-21_china-has-started-2026-with-two-signals-that-matter-for-bulk-shipping.html
source_stem: 2026-01-21_china-has-started-2026-with-two-signals-that-matter-for-bulk-shipping
source_url: https://www.breakwaveadvisors.com/insights/2026/1/21/china-has-started-2026-with-two-signals-that-matter-for-bulk-shipping
summary: 'Main

  By Yiannis Parganas

  China has started 2026 with two signals that matter for bulk shipping in different
  ways. One is policy-driven and hits steel trade flows directly. The other is balance-sheet
  driven and shows up first in iron ore restocking behaviour.'
themes:
- capesize
- supramax
- handysize
...
- australia
- atlantic
title: China has started 2026 with two signals that matter for bulk shipping
vessel_classes:
- capesize
- panamax
- supramax
