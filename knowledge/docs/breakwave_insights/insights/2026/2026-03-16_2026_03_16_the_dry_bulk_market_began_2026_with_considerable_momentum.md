...
- steel
date: '2026-03-16'
doc_id: breakwave_insights_insights_2026-03-16_2026_03_16_the_dry_bulk_market_began_2026_with_considerable_momentum
...
- section: Main
  section_type: null
  source_line: The dry bulk market began 2026 with considerable momentum. During the
    first two months of the year, freight markets across all vessel segments performed
    significantly above typical seasonal patterns. The Capesize and Panamax segments
    in particular reached mult
  unit: usd
  values:
  - 2026.0
  - 28000.0
...
- section: Main
  section_type: null
  source_line: However, this favourable market environment has now been overshadowed
    by a sudden geopolitical escalation. During the course of this week, tensions
    between the United States and Iran intensified following military strikes in the
    region, introducing a new layer
  unit: null
  values:
  - 4.0
  - 7.0
...
- section: Main
  section_type: null
  source_line: A number of important commodities are involved in these flows. Imports
    into the Persian Gulf primarily consist of grain, iron ore and steel products,
    which support regional construction, manufacturing and infrastructure development.
    On the export side, the reg
  unit: null
  values:
  - 52.0
  - 45.0
...
source_path: reports/breakwave/2026/2026-03-16_the-dry-bulk-market-began-2026-with-considerable-momentum.html
source_stem: 2026-03-16_the-dry-bulk-market-began-2026-with-considerable-momentum
source_url: https://www.breakwaveadvisors.com/insights/2026/3/16/the-dry-bulk-market-began-2026-with-considerable-momentum
summary: 'Main

  By Michalis Voutsinas

  The dry bulk market began 2026 with considerable momentum. During the first two
  months of the year, freight markets across all vessel segments performed significantly
  above typical seasonal patterns. The Capesize and Panamax segments in particular
  reached multi-year highs for the first-quarter period, while the Supramax and Handysize
  segments also maintained firm market conditions.'
themes:
- capesize
- panamax
- supramax
...
- lng
- china
title: The dry bulk market began 2026 with considerable momentum
vessel_classes:
- capesize
- panamax
- supramax
