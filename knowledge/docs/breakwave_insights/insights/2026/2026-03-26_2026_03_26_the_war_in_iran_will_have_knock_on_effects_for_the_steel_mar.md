...
- steel
date: '2026-03-26'
doc_id: breakwave_insights_insights_2026-03-26_2026_03_26_the_war_in_iran_will_have_knock_on_effects_for_the_steel_mar
...
- section: Main
  section_type: null
  source_line: ● Flows from China have increased by 6%.
  unit: worldscale_pct
  values:
  - 6.0
- section: Main
  section_type: null
  source_line: ● Flows from outside of China have decreased by 4%.
  unit: worldscale_pct
  values:
  - 4.0
- section: Main
  section_type: null
  source_line: ● Indonesia's seaborne imports of steel surged by over 42% in February.
  unit: pct
  values:
  - 42.0
- section: Main
  section_type: null
  source_line: Seaborne steel flows reached 21.1mt in February 2026, up less than
    1% from the same period last year. The global flatline came despite a 6% rise
    in steel flows from China, as this was mitigated by an aggregated fall of 4% elsewhere.
  unit: worldscale_pct
  values:
  - 21.1
  - 2026.0
...
- section: Main
  section_type: null
  source_line: The relationship between Chinese steel exports and domestic steel production
    continued in the typical trend in 2026 so far. Weaker domestic production, a result
    of weak domestic demand, drives producers to find export markets. For the first
    two months of 2026,
  unit: pct
  values:
  - 2026.0
...
- section: Main
  section_type: null
  source_line: 'The largest receiver of these increased flows has been nations in
    South East Asia, most notably Indonesia, Singapore, and Malaysia, which have combined
    to account for just shy of 20% of all Chinese steel exports in 2026 so far. These
    regions have absorbed the '
  unit: worldscale_pct
  values:
  - 20.0
  - 2026.0
- section: Main
  section_type: null
  source_line: The disruption in the Arabian Gulf has yet to materially impact global
    steel flows, although early signs of regional dislocation are emerging. Historically,
    the region accounts for around 11% of Chinese steel exports, making it the single
    largest regional dest
  unit: worldscale_pct
  values:
  - 11.0
  - 2026.0
...
- section: Main
  section_type: null
  source_line: 'Steel production remains highly energy-intensive, accounting for approximately
    7-8% of global final energy demand. Sustained increases in energy prices would
    push production costs and compress margins. Rather than driving immediate demand
    destruction, this is '
  unit: pct
  values:
  - 7.0
...
- section: Main
  section_type: null
  source_line: Chinese steel exports in 2026 by destination region from Signal Ocean
  unit: null
  values:
  - 2026.0
regions:
...
source_path: reports/breakwave/2026/2026-03-26_the-war-in-iran-will-have-knock-on-effects-for-the-steel-mar.html
source_stem: 2026-03-26_the-war-in-iran-will-have-knock-on-effects-for-the-steel-mar
source_url: https://www.breakwaveadvisors.com/insights/2026/3/26/the-war-in-iran-will-have-knock-on-effects-for-the-steel-markets-in-the-upcoming-months
summary: 'Main

  Key Takeaways

  ● Global steel flows remain flat in February. ● Flows from China have increased
  by 6%. ● Flows from outside of China have decreased by 4%.'
themes:
- china
- atlantic
- pacific
...
- europe
- singapore
title: The War In Iran Will Have Knock On Effects For The Steel Markets In The Upcoming
  Months
vessel_classes:
- capesize
- panamax
...
Main
Key Takeaways
● Global steel flows remain flat in February. ● Flows from China have increased by 6%. ● Flows from outside of China have decreased by 4%.
