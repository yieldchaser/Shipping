...
- gas
date: '2026-04-01'
doc_id: breakwave_insights_insights_2026-04-01_2026_04_01_a_direct_threat_to_the_gulf_business_model
...
- section: Main
  section_type: null
  source_line: 'The UAE is probably the clearest case. Dubai welcomed 19.59 million
    overnight visitors in 2025. DXB handled a record 95.2 mil-lion passengers, the
    highest annual international traffic ever rec-orded by any airport. This is not
    a small side business. It is the '
  unit: null
  values:
  - 19.59
  - 2025.0
...
- section: Main
  section_type: null
  source_line: 'Saudi Arabia faces the same issue in a different form. Vision 2030
    still looks huge on paper, but it is also capital-hungry and confi-dence-sensitive.
    The Kingdom''s 2026 budget projects a deficit of around SAR 165 billion. PIF assets
...
- section: Main
  section_type: null
  source_line: For shipping, the logic is even clearer. Before this war, the Strait
    of Hormuz carried about one fifth of global oil and LNG flows. War-risk premiums
    have jumped from around 0.25 percent of vessel value to as much as 3 percent in
    some cases. At least nine vess
  unit: null
  values:
  - 0.25
  - 3.0
...
source_path: reports/breakwave/2026/2026-04-01_a-direct-threat-to-the-gulf-business-model.html
source_stem: 2026-04-01_a-direct-threat-to-the-gulf-business-model
source_url: https://www.breakwaveadvisors.com/insights/2026/4/1/a-direct-threat-to-the-gulf-business-model
summary: 'Main

  By Yiannis Parganas

  For most of the past decade, the Gulf states tried to live with Iran rather than
  settle the Iran problem. They hardened air defence, built diplomatic channels, and
  kept repeating the same basic for-mula. Contain the threat, avoid a regional war,
  and keep the eco-nomic transformation story moving.'
themes:
- lng
- crude_oil
- gas
...
- gulf
- already
title: A direct threat to the Gulf business model
vessel_classes:
- capesize
- panamax
- supramax
...
Main
By Yiannis Parganas
For most of the past decade, the Gulf states tried to live with Iran rather than settle the Iran problem. They hardened air defence, built diplomatic channels, and kept repeating the same basic for-mula. Contain the threat, avoid a regional war, and keep the eco-nomic transformation story moving.
