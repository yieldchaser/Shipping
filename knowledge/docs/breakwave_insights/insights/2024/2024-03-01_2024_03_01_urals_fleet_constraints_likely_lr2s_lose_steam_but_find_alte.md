...
- gas
date: '2024-03-01'
doc_id: breakwave_insights_insights_2024-03-01_2024_03_01_urals_fleet_constraints_likely_lr2s_lose_steam_but_find_alte
...
- section: Main
  section_type: null
  source_line: Since Urals was first assessed above the $60/barrel price cap in mid-July
    2023 (Argus Media), the number of tankers leaving the Urals trade and not returning
    increased considerably, averaging 20 tankers each month through January. At the
...
- section: Main
  section_type: null
  source_line: Difficulties in remaining sanctions-compliant has led to an exodus
    of EU operators (currently 19% Greek-operated tankers have loaded vs 39% before
    from Dec22-Jul23). The change in fleet composition plus the overall fleet shrinking
    points to increasing constrai
  unit: pct
  values:
  - 19.0
  - 39.0
...
- section: Main
  section_type: null
  source_line: According to our new voyage dynamics screen , the developments unfolded
    following the Red Sea attacks have driven laden LR voyage mileage to 14-month
    highs.
  unit: null
  values:
  - 14.0
- section: Main
  section_type: null
  source_line: Aframax tonne-miles out of the US Gulf remain muted, keeping freight
    rates USG-to-Europe (TD25) in check.
  unit: null
  values:
  - 5.0
- section: Main
  section_type: null
  source_line: A 35% m-o-m Increase in STS activity so far in February points towards
    increased employment of larger vessels for longer haul voyages, with Aframaxes
    relegated to lightering roles and some Transatlantic flows. This is also keeping
    prompt vessel supply relative
  unit: worldscale_pct
  values:
  - 35.0
- section: Main
  section_type: null
  source_line: As the US refinery maintenance season continues in full-swing, MR demand
    out of the US Gulf continues to decline, with both utilisation and tonne-mile
    demand falling since early January. Our data points to slightly tightening availability
    in natural fixing win
  unit: null
  values:
  - 4.0
  - 8.0
- section: Main
  section_type: null
  source_line: Though weather conditions and available transit slots through the Panama
    Canal have recovered some, southbound MR transits from the US Gulf remain low.
    This occurs at a time when South America West Coast demand has slowed down, and
    the region is relying more o
  unit: null
  values:
  - 5.0
- section: Main
  section_type: null
  source_line: Weaker demand in Brazil plus the continued displacement of US Gulf
    diesel by Russian and now some MEG barrels will continue to suppress tanker demand
    USG-to-South America East Coast. USG-to-NW Europe diesel exports have increased
    over 15% m-o-m (Feb days 1-26)
  unit: pct
  values:
  - 15.0
  - 1.0
...
source_path: reports/breakwave/2024/2024-03-01_urals-fleet-constraints-likely-lr2s-lose-steam-but-find-alte.html
source_stem: 2024-03-01_urals-fleet-constraints-likely-lr2s-lose-steam-but-find-alte
source_url: https://www.breakwaveadvisors.com/insights/2024/3/1/urals-fleet-constraints-likely-lr2s-lose-steam-but-find-alternative-employment
summary: 'Main

  This week, in the East, we discuss why capacity restraints look increasingly likely
  for the fleet trading Russian Urals. On the clean side, we explore where LR2s in
  the EoS are seeking alternative employment as a result of falling European middle
  distillate imports from the East. In the West, we focus on muted tanker demand in
  the US Gulf for both Aframaxes and MRs.'
themes:
- capesize
- aframax
- brazil
...
- meg
- europe
title: Urals Fleet Constraints Likely Lr2S Lose Steam But Find Alternative Employment
vessel_classes:
- capesize
- panamax
- supramax
...
The Red Sea attacks, however, have sparked marginal reshuffling of flows to Asia as well as South America , which is materialising mostly on LRs. Similarly, Red Sea-to-Europe flows which bypass the Bab-el Mandeb have also picked-up, benefitting the vessel class.
According to our new voyage dynamics screen , the developments unfolded following the Red Sea attacks have driven laden LR voyage mileage to 14-month highs.
Aframax tonne-miles out of the US Gulf remain muted, keeping freight rates USG-to-Europe (TD25) in check.
