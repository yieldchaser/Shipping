...
- section: Main
  section_type: null
  source_line: The US Federal Reserve came under severe criticism in 2022, for underestimating
    inflation and allowing it to run off. While there were externalities linked to
    price hikes (the war in Ukraine), the US Central Bank was widely panned for its
    certainty that inflat
  unit: null
  values:
  - 2022.0
- section: Main
  section_type: null
  source_line: 'Investors thought that the Fed, which changed direction abruptly would
    continue to remain cautious. During the September 2024 meeting, those expectations
    were, by and large, disproved, with the world''s most important central bank deciding
    an aggressive double '
  unit: pct
  values:
  - 2024.0
  - 0.5
- section: Main
  section_type: null
  source_line: 'Economists and strategists, as well as our own House View, suggested
    that economic growth was good, albeit slowing, the labour market was weakening
    but not to the point of worry and that services inflation persisted, even as headline
    inflation receded, mostly '
  unit: null
  values:
  - 2024.0
- section: Main
  section_type: null
  source_line: Second, investors will have to consider whether the US economy and
    corporate earnings are more stressed than what they appear to be . A central bank
    cutting aggressively could, even inadvertently, emit a distress signal to markets
    and investors. One could poin
  unit: null
  values:
  - 2008.0
regions:
...
- central
- markets
title: The Fed cut rates aggressively. Now what?
vessel_classes:
- capesize
- panamax
- supramax
