...
- gas
date: '2024-02-20'
doc_id: breakwave_insights_insights_2024-02-20_2024_02_20_the_equity_rally_and_the_perilous_promises_of_artificial_int
...
- section: Main
  section_type: null
  source_line: The bond market is now pricing in 3.5 cuts later in the year, a far
    cry from the 7 cuts six weeks ago and much closer to the Fed's own projection
    for 3.
  unit: null
  values:
  - 3.5
...
- section: Main
  section_type: null
  source_line: The equity market corrected a bit, but this didn't last long. A 2%
    intra-day drop was limited to -1.44% by the end of the session, and bullishness
    resumed thereafter. The S&P 500 is roughly where it was before the CPI announcement.
  unit: pct
  values:
  - 2.0
  - -1.44
...
- section: Main
  section_type: null
  source_line: Having said that, bond markets never really found their way to December's
    bullishness, and are now down more than 2% for the year…
  unit: pct
  values:
  - 2.0
- section: Main
  section_type: null
  source_line: There's no other way to read this, other than the market simply being
    in a bullish mood. If anyone has any doubts, Bitcoin (a bellwether of optimism
    if there has ever been one) is trading back above $50k.
  unit: usd
  values:
  - 50.0
- section: Main
  section_type: null
  source_line: Let's focus on tech equities, however, as they clearly are the key
    drivers of the rally. Nvidia, a global chip maker and key driver of this rally,
    now boasts a capitalisation higher than the whole of the S&P 500 Energy sector.
    The company trades at 93x times i
  unit: pct
  values:
  - 500.0
  - 93.0
...
- section: Main
  section_type: null
  source_line: Much as I hate exorbitant valuations, there's some reasoning behind
    the exuberance. As electric vehicles take off (EVs require double the number of
    microchips versus a conventional car), countries hoard chips and companies compete
    for the next AI-based app, de
  unit: null
  values:
  - 20.0
- section: Main
  section_type: null
  source_line: Yet still, it's difficult to account for a 50% rally in six weeks.
  unit: pct
  values:
  - 50.0
- section: Main
  section_type: null
  source_line: A 1994 article in Time Magazine, introduced readers to the internet
  unit: null
  values:
  - 1994.0
- section: Main
  section_type: null
  source_line: Reading the article, their advice was mostly about using the internet
    to send emails. Yet, a few years later, by 1999, tech valuations had become exorbitant.
    "No company can exist unless it's online", tech gurus proclaimed. They proved
    right, but it took anoth
  unit: null
  values:
  - 1999.0
  - 1994.0
- section: Main
  section_type: null
  source_line: The second risk is that the tech may simply fail to live up to its
    potential. People would rather talk to people rather than robots. Most importantly
    they trust people more than robots. If a century's worth of Sci-Fi, from H.G.
    Well's "War of the Worlds" and F
  unit: usd
  values:
  - 2008.0
  - 2020.0
...
- section: Main
  section_type: null
  source_line: The third key risk is that microchips could become an obsolete technology
    . Exotic as this claim may sound, the future of computing, and I suspect AI, may
    lie away from traditional computing. Modern computing is largely based on "Moore's
    Law". Gordon Moore, an
  unit: null
  values:
  - 1965.0
...
- section: Main
  section_type: null
  source_line: While this is still the case, for various technical reasons, while
    we can keep adding transistors we are reaching the point where computing power
    (clock speed) is levelling out. We can keep stringing processors together, of
    course, to increase computing power,
  unit: null
  values:
  - 2000.0
- section: Main
  section_type: null
  source_line: While there is a case for this wild tech rally, the buzz around the
    potential of AI far outstrips visible evidence. Yet it persists, unabated. After
    winning a board room war, Sam Altman, founder of Chat GPT, is now asking for a
    $7tn investment, more than the a
  unit: usd
  values:
  - 7.0
  - 2.5
...
source_path: reports/breakwave/2024/2024-02-20_the-equity-rally-and-the-perilous-promises-of-artificial-int.html
source_stem: 2024-02-20_the-equity-rally-and-the-perilous-promises-of-artificial-int
source_url: https://www.breakwaveadvisors.com/insights/2024/2/20/the-equity-rally-and-the-perilous-promises-of-artificial-intelligence
summary: 'Main

  The three things investors should know this week:

  The macroeconomy is no longer driving the equity market. After last week''s US CPI
  announcement, rate cut expectations are now back near October levels, and much closer
  to reality. While bond markets adjusted, equity markets are still rallying, mostly
...
- tech
- can
title: The Equity Rally And The Perilous Promises Of Artificial Intelligence
vessel_classes:
- capesize
- panamax
- supramax
...
Main
The three things investors should know this week:
The macroeconomy is no longer driving the equity market. After last week's US CPI announcement, rate cut expectations are now back near October levels, and much closer to reality. While bond markets adjusted, equity markets are still rallying, mostly on the back of technology.
