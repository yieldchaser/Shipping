...
- steel
date: '2024-08-09'
doc_id: breakwave_insights_insights_2024-08-09_2024_08_09_crude_oil_gains_amid_a_broader_rally_across_risk_asset_class
...
- section: Market Commentary
  section_type: null
  source_line: 'Crude oil continued it recovery from its recent plunge as elevated
    geopolitical risks came into focus. Israel remains on edge as it prepares for
    a retaliatory attack from Iran following the assassination of Hamas and Hezbollah
    leaders. However, a call between '
  unit: pct
  values:
  - 270.0
  - 14.0
...
- section: Market Commentary
  section_type: null
  source_line: Iron ore futures fell sharply as sentiment continues to be battered
    by strong supply and weak demand. Futures on the Singapore Exchange fell below
    USD100/t, a level the market has tested, but ultimately pushed back above several
    times this year. Shipments from
  unit: tonnage
  values:
  - 16.5
  - 26.0
...
source_path: reports/breakwave/2024/2024-08-09_crude-oil-gains-amid-a-broader-rally-across-risk-asset-class.html
source_stem: 2024-08-09_crude-oil-gains-amid-a-broader-rally-across-risk-asset-class
source_url: https://www.breakwaveadvisors.com/insights/2024/8/9/crude-oil-gains-amid-a-broader-rally-across-risk-asset-classes
summary: 'Main

  A risk-on tone across broader financial markets helped push commodity markets higher.
  Supply side issues also remained in focus. By Daniel Hynes


  Market Commentary

  Crude oil continued it recovery from its recent plunge as elevated geopolitical
...
- singapore
- japan
title: Crude Oil Gains Amid A Broader Rally Across Risk Asset Classes
vessel_classes:
- capesize
- panamax
- supramax
...
## Summary
Main
A risk-on tone across broader financial markets helped push commodity markets higher. Supply side issues also remained in focus. By Daniel Hynes

Market Commentary
Crude oil continued it recovery from its recent plunge as elevated geopolitical risks came into focus.
