...
- section: Main
  section_type: null
  source_line: The philosopher Heraclitus (500 BC) wouldn't bat an eyelid. "Everything
    is in flux, the world becomes but never is" he'd say, as if he knew that the earth
    is a weird looking pear-shaped object perpetually spinning and catapulting in
    space at 450,000 mph, while
  unit: null
  values:
  - 500.0
  - 450000.0
- section: Main
  section_type: null
  source_line: The world is in flux and will continue to be. As we have often pointed
    out, in the meantime someone who stayed glued to the newspaper headlines and avoided
    investing has an opportunity cost of 46% in 22 months.
  unit: worldscale_pct
  values:
  - 46.0
- section: Main
  section_type: null
  source_line: Central banks have shifted focus from inflation to growth - with inflation
    ostensibly under control, central banks stand ready to provide stimulus to support
    growth (i.e. cut rates). The shift in central bank focus is extremely important
    for the economy and ma
  unit: pct
  values:
  - 50.0
  - 5.0
- section: Main
  section_type: null
  source_line: The "New New Normal"… is the "Old Normal"- markets need less intervention
    from policymakers. No more zero rates and negligible inflation. A key change that
    we have often noted is that the US central bank, for the first time since its
    creation in 1913 has decid
  unit: null
  values:
  - 1913.0
- section: Main
  section_type: null
  source_line: 'Can China break out of its Malaise? China has a huge impact on the
    global economy, including through the export of disinflation and as a consumption
    powerhouse. China is the biggest question mark in 2024 and possibly 2025. The
    data suggests that it is slowing '
  unit: null
  values:
  - 2024.0
  - 2025.0
