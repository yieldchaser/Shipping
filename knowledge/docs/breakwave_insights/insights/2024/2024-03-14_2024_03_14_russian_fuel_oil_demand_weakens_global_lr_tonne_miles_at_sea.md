...
- gas
date: '2024-03-14'
doc_id: breakwave_insights_insights_2024-03-14_2024_03_14_russian_fuel_oil_demand_weakens_global_lr_tonne_miles_at_sea
...
linked_assets_skipped: 16
market_tone: cautiously_bearish
numeric_observation_count: 6
numeric_observations:
- section: Main
  section_type: null
  source_line: Utilisation of tankers carrying Russian fuel oil has declined compared
    to highs in Q2 2023. Though slightly increased from one-year lows in mid-Feb 2024,
    low overall utilisation is driven by declines in employment to the Med and Middle
    East.
  unit: null
  values:
  - 2023.0
...
- section: Main
  section_type: null
  source_line: At the same time, increased exports of fuel oil to Asia are displacing
    Russian volumes to some extent. As MEG refineries return from maintenance, more
    fuel oil exports are heading to Asia. Fuel oil exports MEG-to-Asia increased 30%
    m-o-m from January to Februa
  unit: pct
  values:
  - 30.0
  - 1.0
...
- section: Main
  section_type: null
  source_line: Diversions around the Cape of Good Hope became the norm for middle
    distillates going East of Suez-to-Europe after US/UK retaliatory strikes began
    on 12 Jan. February was the first full month of this new reality, and it is dramatically
...
- section: Main
  section_type: null
  source_line: 'Europe''s imports of US crude carried on Suezmaxes were almost 60%
    higher in March (days 1-10) compared to February. This has resulted in an increase
    in Suezmax tonne-miles from the US-to-Europe , which were 40% higher than the
    2023 average for the week ending '
  unit: pct
  values:
  - 60.0
  - 1.0
...
- section: Main
  section_type: null
  source_line: From a vessel supply-side perspective, high accumulation of tonnage
    in the Atlantic Basin incentivises Suezmaxes to compete on the traditional Aframax
    route from USG-to-Europe ( TD25 ), explaining why Aframax rates remain muted despite
    continued tanker demand.
  unit: null
  values:
  - 5.0
- section: Main
  section_type: null
  source_line: 'Even though prompt tonnage is currently thinning and easing some of
    the supply side pressure in NW Europe, gasoline stocks in PADD 1 are at the top
    of the five-year seasonal range (source: EIA). This could indicate less demand
    for transatlantic voyages, which '
  unit: null
  values:
  - 1.0
regions:
...
source_path: reports/breakwave/2024/2024-03-14_russian-fuel-oil-demand-weakens-global-lr-tonne-miles-at-sea.html
source_stem: 2024-03-14_russian-fuel-oil-demand-weakens-global-lr-tonne-miles-at-sea
source_url: https://www.breakwaveadvisors.com/insights/2024/3/14/russian-fuel-oil-demand-weakens-global-lr-tonne-miles-at-seasonal-high
summary: 'Main

  This week, in the East, we investigate weakening demand for Russian fuel oil cargoes.
  On the clean side, we explain why LR rates have cooled off despite seasonal highs
  in global tonne-miles. In the West, we discuss increased Suezmax employment from
  US-to-Europe, and we look at why demand on TC2 is likely to remain muted.'
themes:
- capesize
- suezmax
- aframax
...
- meg
- europe
title: Russian Fuel Oil Demand Weakens Global Lr Tonne Miles At Seasonal High
vessel_classes:
- capesize
- panamax
- supramax
