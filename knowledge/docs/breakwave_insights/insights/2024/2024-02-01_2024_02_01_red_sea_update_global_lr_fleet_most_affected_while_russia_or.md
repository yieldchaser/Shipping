...
- gas
date: '2024-02-01'
doc_id: breakwave_insights_insights_2024-02-01_2024_02_01_red_sea_update_global_lr_fleet_most_affected_while_russia_or
...
- section: LRs and the outsized impact from Red Sea attacks
  section_type: null
  source_line: Clean tanker transits via the Bab-el-Mandeb have continued to decline
    since Red Sea attacks on non-Israeli vessels began mid-December. Southbound transits
    have largely stopped, hovering at slightly over one transit per day on a moving
    average basis. CPP volume
  unit: null
  values:
  - 12.0
- section: LRs and the outsized impact from Red Sea attacks
  section_type: null
  source_line: The flow most affected by these northbound diversions are middle distillates
    from West Coast (WC) India or the Middle East heading to Europe. Beginning a steady
    decline in December, the drastic curtailment of volumes transiting via Bab-el-Mandeb
    has gathered p
  unit: pct
  values:
  - 12.0
...
- section: LRs and the outsized impact from Red Sea attacks
  section_type: null
  source_line: Middle distillate cargoes from the Middle East and West Coast India
    are traditionally carried on the bigger LR tankers. Freight rates from India-to-UK
    Cont ( TC8 for LR1s and TC20 for LR2s) for these vessel classes have increased
    87% and 95% respectively since
  unit: pct
  values:
  - 87.0
  - 95.0
  ...
  - 8.0
  - 18.0
- section: Which transits continue, and does the recent attack change anything?
  section_type: null
  source_line: This evidence around low CPP transits through the Red Sea begs the
    question, which tankers are still transiting the route? From 23 - 27 Jan (inclusive),
    44% of all transits via the Bab-el-Mandeb were Russian-origin cargoes, mostly
    either crude or DPP. 30% were
  unit: pct
  values:
  - 23.0
  - 27.0
...
source_path: reports/breakwave/2024/2024-02-01_red-sea-update-global-lr-fleet-most-affected-while-russia-or.html
source_stem: 2024-02-01_red-sea-update-global-lr-fleet-most-affected-while-russia-or
source_url: https://www.breakwaveadvisors.com/insights/2024/2/1/red-sea-update-global-lr-fleet-most-affected-while-russia-origin-oil-continues-to-transit
summary: 'Main

  We investigate the impact of the Red Sea situation on the LR fleet and contextualise
  Red Sea diversions in light of the recent attack. By Mary Melton


  LRs and the outsized impact from Red Sea attacks

  Clean tanker transits via the Bab-el-Mandeb have continued to decline since Red
  Sea attacks on non-Israeli vessels began mid-December. Southbound transits have
  largely stopped, hovering at slightly over one transit per day on a moving average
  basis.'
themes:
- capesize
- meg
...
- products
- sea
title: Red Sea Update Global Lr Fleet Most Affected While Russia Origin Oil Continues
  To Transit
vessel_classes:
- capesize
- panamax
...
## Summary
Main
We investigate the impact of the Red Sea situation on the LR fleet and contextualise Red Sea diversions in light of the recent attack. By Mary Melton

LRs and the outsized impact from Red Sea attacks
Clean tanker transits via the Bab-el-Mandeb have continued to decline since Red Sea attacks on non-Israeli vessels began mid-December. Southbound transits have largely stopped, hovering at slightly over one transit per day on a moving average basis.
