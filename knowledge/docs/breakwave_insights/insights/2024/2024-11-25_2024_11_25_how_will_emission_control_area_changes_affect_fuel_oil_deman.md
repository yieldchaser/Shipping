...
- gas
date: '2024-11-25'
doc_id: breakwave_insights_insights_2024-11-25_2024_11_25_how_will_emission_control_area_changes_affect_fuel_oil_deman
...
- section: Main
  section_type: null
  source_line: Since the start of 2015, the International Maritime Organization (IMO)
    has restricted vessels travelling through designated Emission Control Areas (ECA)
    from using fuel oil bunkers with a sulphur content of over 0.1%. The designated
    zones include the Baltic Se
  unit: pct
  values:
  - 2015.0
  - 0.1
...
- section: Main
  section_type: null
  source_line: The tightening of sulphur limits has led to a sharp decline in global
    high sulphur fuel oil (HSFO) liftings in 2020 as vessel operators adhere to the
    new regulations. Back in 2019, although vessel owners had the option of installing
    an exhaust gas cleaning sys
  unit: null
  values:
  - 2020.0
  - 2019.0
- section: Main
  section_type: null
  source_line: The IMO's decision to expand the ECA to include the Mediterranean Sea,
    effective from 1st May 2025, will impact vessel operators. This expansion will
    limit fuel oil bunkers to 0.1% sulphur, with exemptions for vessels running on
    cleaner fuels such as liquified
  unit: pct
  values:
  - 1.0
  - 2025.0
...
- section: Main
  section_type: null
  source_line: The trend for scrubber retrofitting activity for current vessels, which
    excludes new builds, has picked up in recent months, highlighting the incentive
    for ship owners to use HSFO instead of ultra-low sulphur fuel oil (ULSFO) or 10ppm
    gasoil. Given the large s
  unit: usd
  values:
  - 10.0
  - 10.0
...
source_path: reports/breakwave/2024/2024-11-25_how-will-emission-control-area-changes-affect-fuel-oil-deman.html
source_stem: 2024-11-25_how-will-emission-control-area-changes-affect-fuel-oil-deman
source_url: https://www.breakwaveadvisors.com/insights/2024/11/25/how-will-emission-control-area-changes-affect-fuel-oil-demand-in-the-mediterranean
summary: 'Main

  The upcoming Mediterranean Emission Control Area will likely tighten ULSFO supplies
  in the region and free up VLSFO supplies for the East. By Xavier Tang

  Since the start of 2015, the International Maritime Organization (IMO) has restricted
  vessels travelling through designated Emission Control Areas (ECA) from using fuel
  oil bunkers with a sulphur content of over 0.1%. The designated zones include the
  Baltic Sea, North Sea, North America and the US Caribbean Sea.'
themes:
- vlcc
- lng
- atlantic
...
- europe
- crude_oil
title: How Will Emission Control Area Changes Affect Fuel Oil Demand In The Mediterranean
vessel_classes:
- capesize
- panamax
- supramax
...
## Summary
Main
The upcoming Mediterranean Emission Control Area will likely tighten ULSFO supplies in the region and free up VLSFO supplies for the East. By Xavier Tang
