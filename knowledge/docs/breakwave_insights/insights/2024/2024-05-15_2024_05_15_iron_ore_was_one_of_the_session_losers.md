...
- steel
date: '2024-05-15'
doc_id: breakwave_insights_insights_2024-05-15_2024_05_15_iron_ore_was_one_of_the_session_losers
...
- section: Main
  section_type: null
  source_line: Crude oil continued its swing between limited daily gains and losses
    yesterday. Reports that the members of OPEC+ pumped more oil than their allotted
    quotas last month weighed on prices. The July Brent futures ended Tuesday's session
    at 82.38 dollars per barre
  unit: null
  values:
  - 82.38
  - 1.2
- section: Main
  section_type: null
  source_line: After two days of substantial losses, European natural gas prices edged
    up yesterday as renewed concerns over supplies offset lower demand. Increasing
    global competition for LNG cargoes saw the front-month TTF futures gaining 0.3
    per cent durng yesterday's ses
  unit: null
  values:
  - 0.3
  - 29.67
...
- section: Main
  section_type: null
  source_line: Coal prices continued to retreat from the levels seen in early May
    as markets remained well-supplied and demand faced some headwinds. The June futures
    for delivery in the Australian port of Newcastle declined by 1.0 per cent, settling
    at 138.65 dollars per ton
  unit: null
  values:
  - 1.0
  - 138.65
...
- section: Main
  section_type: null
  source_line: 'Iron ore ended yesterday''s trading in the red after recording gains
    during the previous three sessions. The June futures listed on the SGX retreated
    by 1.9 per cent, settling at 114.87 dollars per tonne. Rising inventories and
    concerns over the demand outlook '
  unit: null
  values:
  - 1.9
  - 114.87
- section: Main
  section_type: null
  source_line: The base metals recorded relatively minor daily moves yesterday. The
    three-month copper and nickel futures listed on the LME declined by 0.7 and 0.8
    per cent, respectively. On the other hand, the aluminium and zinc futures edged
    up marginally.
  unit: null
  values:
  - 0.7
...
- section: Main
  section_type: null
  source_line: After two days of solid gains, the CBOT wheat futures for delivery
    in July declined by 1.6 per cent yesterday amid an improving outlook for US winter
    wheat. Despite a 1.1 per cent decline yesterday, the corn futures remained near
    the highest level since the be
  unit: null
  values:
  - 1.6
  - 1.1
...
- section: Main
  section_type: null
  source_line: After a period of daily gains during the early stages of the month,
    the Baltic Dry Index retreated for a fourth consecutive session on Tuesday. The
    headline index shed 3.5 per cent yesterday, with much of the negative momentum
    originating in the largest segmen
  unit: null
  values:
  - 3.5
- section: Main
  section_type: null
  source_line: The sub-index for the capesizes dropped by 5.7 per cent yesterday amid
    weak demand in the Atlantic basin. The gauge for the panamaxes recorded a decline
    of 1.9 per cent as cargo ordering activities in the Indian Ocean and the Atlantic
    faced some headwinds. The
  unit: null
  values:
  - 5.7
  - 1.9
...
- section: Main
  section_type: null
  source_line: In contrast, the Baltic Exchange's wet freight indices stayed out of
    the red yesterday. The clean tanker indicator advanced by 3.2 per cent, while
    the index for the dirty tankers remained unchanged. The gauge for the LNG carriers
    rose 1.1 per cent, while the L
  unit: null
  values:
  - 3.2
  - 1.1
...
- section: Main
  section_type: null
  source_line: Following losses across the board on Monday, the trading in bunker
    fuels was more mixed on Tuesday in the world's leading maritime hubs. The VLSFO
    gained half a per cent in Houston while declining by 0.5 per cent in Singapore
    and 0.2 per cent in Rotterdam. The
  unit: null
  values:
  - 0.5
  - 0.2
...
- section: Main
  section_type: null
  source_line: The past two months have seen a seasonal decline in demand for seaborne
    transportation of agricultural commodities between the world's two largest economies.
    At the same time, Chinese demand for US coal has been strong. Last month, cargo
    order volumes for US c
  unit: null
  values:
  - 1.8
- section: Main
  section_type: null
  source_line: 'Image reference: unnamed.png | assets/2024-05-15_iron-ore-was-one-of-the-session-losers_img_unnamed_9be314d4130a.png'
  unit: null
  values:
  - 2024.0
  - -5.0
  ...
  - 14.0
  - 130.0
- section: 'Linked asset: 2024-05-15_iron-ore-was-one-of-the-session-losers_img_unnamed_9be314d4130a.png'
  section_type: linked_image_asset
  source_line: 'Linked image asset: 2024-05-15_iron-ore-was-one-of-the-session-losers_img_unnamed_9be314d4130a.png'
  unit: null
  values:
  - 2024.0
  - -5.0
...
- section: 'Linked asset: 2024-05-15_iron-ore-was-one-of-the-session-losers_img_unnamed_9be314d4130a.png'
  section_type: linked_image_asset
  source_line: DP oP a PUP oP po? po a SP AP poh po po? p05? ar or a> not oth
  unit: null
  values:
  - 5.0
regions:
...
source_path: reports/breakwave/2024/2024-05-15_iron-ore-was-one-of-the-session-losers.html
source_stem: 2024-05-15_iron-ore-was-one-of-the-session-losers
source_url: https://www.breakwaveadvisors.com/insights/2024/5/15/iron-ore-was-one-of-the-session-losers
summary: 'Main

  The Baltic Dry Index declined for a fourth consecutive session on Tuesday, with
  all segments contributing to the headwinds amid generally softer demand. For the
  commodities, red dominated yesterday''s trading screens. Iron ore was one of the
  session losers, with a decline of nearly two per cent.'
themes:
- capesize
- panamax
- supramax
...
- lng
- lpg
title: Iron ore was one of the session losers
vessel_classes:
- capesize
- panamax
- supramax
...
Image reference: unnamed.png | assets/2024-05-15_iron-ore-was-one-of-the-session-losers_img_unnamed_9be314d4130a.png
Data Source: Shipfix

## Linked asset: 2024-05-15_iron-ore-was-one-of-the-session-losers_img_unnamed_9be314d4130a.png
Source asset: reports/breakwave/2024/assets/2024-05-15_iron-ore-was-one-of-the-session-losers_img_unnamed_9be314d4130a.png

Linked image asset: 2024-05-15_iron-ore-was-one-of-the-session-losers_img_unnamed_9be314d4130a.png
...
OCR text:
Weekly Cargo Order Volumes (TCT & Voyage) for US Dry Bulk Bound for China
® Other dry bulk @ Coal @® Agricultural commodities
3
2
2
S
= 1
ft)
DP oP a PUP oP po? po a SP AP poh po po? p05? ar or a> not oth
SoM GAM GO SO GO NT GTEC
Data source: Shipfix