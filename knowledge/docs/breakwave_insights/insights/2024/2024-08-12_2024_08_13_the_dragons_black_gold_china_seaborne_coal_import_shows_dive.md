...
- gas
date: '2024-08-12'
doc_id: breakwave_insights_insights_2024-08-12_2024_08_13_the_dragons_black_gold_china_seaborne_coal_import_shows_dive
...
- section: Main
  section_type: null
  source_line: The latest official customs data shows that China's coal imports hit
    a record 249.6mln mt in 1H24, an astounding 11.9% year-on-year increase. The total
    import volume of thermal coal reached 192mln mt, which is 9.0% higher than the
    176mln mt recorded over the s
  unit: worldscale_pct
  values:
  - 249.6
  - 1.0
...
- section: Main
  section_type: null
  source_line: In this context, market players have gradually tuned up their annual
    coal import projections from the initial expectation in February of 400mln mt
    (of which thermal coal accounted for around 310mln mt), to current forecasts of
    around the 500mln mt mark (of whi
  unit: tonnage
  values:
  - 400.0
  - 310.0
...
- section: Main
  section_type: null
  source_line: 'When examining these imports on a country-by-country basis, despite
    the double digits surge in coal import volumes on the year, the divergence in
    volumes among various regions within China is noteworthy. Breaking down the country
    into three general regions of '
  unit: tonnage
  values:
  - 1.3
  - -3.5
...
- section: Main
  section_type: null
  source_line: 1. Indonesian coal unprofitable in North China
  unit: null
  values:
  - 1.0
- section: Main
  section_type: null
  source_line: For coal buyers in North China, due to their proximity to China's domestic
    key mining regions of Shanxi, Shaanxi, Xinjiang, etc., purchasing domestic coal
    delivered overland can save them seaborne shipping costs. The average cost in
    2023 for cabotage trade fro
  unit: pct
  values:
  - 2023.0
  - 4.6
...
- section: Main
  section_type: null
  source_line: 2. Lower railway cost support domestic coal sales
  unit: null
  values:
  - 2.0
- section: Main
  section_type: null
  source_line: Since the end of April, several local railway bureaus in China have
    announced preferential policies for coal freight, lowering associated freight
    rates by 10-30% based on cargo volume. This is seen as a measure to stimulate
    demand for coal transportation durin
  unit: tonnage
  values:
  - 10.0
  - -30.0
...
- section: Main
  section_type: null
  source_line: 3. Mongolia continues to boost coal production
  unit: null
  values:
  - 3.0
- section: Main
  section_type: null
  source_line: 'China is the sole importer of Mongolian coal and mainly receives coal
    from Mongolia via truck and railway. According to the latest data from Mongolian
    Customs, during 1H24 total coal export volumes reached 39.4mln mt, which is an
    increase of 39.1% and 11.1mln '
  unit: tonnage
  values:
  - 1.0
  - 4.0
...
source_path: reports/breakwave/2024/2024-08-13_the-dragons-black-gold-china-seaborne-coal-import-shows-dive.html
source_stem: 2024-08-13_the-dragons-black-gold-china-seaborne-coal-import-shows-dive
source_url: https://www.breakwaveadvisors.com/insights/2024/8/12/the-dragons-black-gold-china-seaborne-coal-import-shows-divergence-in-1h24
summary: 'Main

  The latest official customs data shows that China''s coal imports hit a record 249.6mln
  mt in 1H24, an astounding 11.9% year-on-year increase. The total import volume of
  thermal coal reached 192mln mt, which is 9.0% higher than the 176mln mt recorded
  over the same period in 2023. The total import value of China''s thermal coal stood
  at $16bln, a 15.8% decrease year-on-year as prices fell to an average of $83.34/t,
  a y-o-y decrease of 22.7%.'
themes:
- china
- pacific
- coal
...
- north
- import
title: The Dragons Black Gold China Seaborne Coal Import Shows Divergence In 1H24
vessel_classes:
- capesize
- panamax
- supramax
...
Indonesian coal is unprofitable in North China
Lower railway cost in China supports domestic coal sales
Mongolia has boosted its coal production and exports
