...
- gas
date: '2024-11-13'
doc_id: breakwave_insights_insights_2024-11-13_2024_11_13_trump_presidency_to_target_iran_but_ultimately_it_is_chinas
...
- section: Main
  section_type: null
  source_line: Trump is likely to ramp up sanctions on Iran, following his policy
    pre-Biden when the United States left the JCPOA and sanctioned Iran unilaterally.
    We've already observed the Biden administration designate a record number of vessels
    in the Iranian trade in 20
  unit: null
  values:
  - 2024.0
  - 1.6
...
- section: Main
  section_type: null
  source_line: One method could be if Trump targets all of the dark fleet VLCCs. Vortexa
    currently tracks over 190 VLCCs which are in the dark fleet, trading across Iran,
    Russia and Venezuela. However, over 60% of this fleet is still non-sanctioned
    and trading. If this remai
  unit: pct
  values:
  - 190.0
  - 60.0
- section: Main
  section_type: null
  source_line: Iran is in a different position to where it was four years ago. Iran
    could respond to heightened sanctions by expanding the dark fleet, bringing in
    more non-sanctioned tankers into the trade. They have expanded their shipping
    network over the last few years, s
  unit: null
  values:
  - 80.0
- section: Main
  section_type: null
  source_line: 'Amid a broader decline in crude demand and weakening refining economics,
    Chinese refiners are increasingly favouring cheaper spot crude to improve margins.
    China''s January-October imports of Iranian crude rose 30% y-o-y, vs a 5% decline
...
- section: Main
  section_type: null
  source_line: In addition to logistics, there are the political considerations regarding
    China and the US. A lot has happened since 2020, notably Russia invading Ukraine
    and both India and China buying record-volumes of its crude whilst Europe turned
    away, and related shipp
  unit: null
  values:
  - 2020.0
- section: Main
  section_type: null
  source_line: In summary, China is the deciding factor in what happens to Iran's
    crude exports, more so than the US. Despite record-high vessel-specific sanctions
    in 2024, coupled with US efforts to target ports via the SHIP act, China's imports
    of Iranian crude hit a recor
  unit: null
  values:
  - 2024.0
regions:
...
source_path: reports/breakwave/2024/2024-11-13_trump-presidency-to-target-iran-but-ultimately-it-is-chinas.html
source_stem: 2024-11-13_trump-presidency-to-target-iran-but-ultimately-it-is-chinas
source_url: https://www.breakwaveadvisors.com/insights/2024/11/13/trump-presidency-to-target-iran-but-ultimately-it-is-chinas-decision-that-matters
summary: 'Main

  What does a Trump presidency mean for Iran and its oil exports? This insight explores
  the potential implications and why the expected impact may actually be minimal.
  By Armen Azizian

  Trump is likely to ramp up sanctions on Iran, following his policy pre-Biden when
  the United States left the JCPOA and sanctioned Iran unilaterally.'
themes:
- vlcc
- china
- europe
...
- crude_oil
- iran
title: Trump Presidency To Target Iran But Ultimately It Is Chinas Decision That Matters
vessel_classes:
- capesize
- panamax
- supramax
...
## Summary
Main
What does a Trump presidency mean for Iran and its oil exports? This insight explores the potential implications and why the expected impact may actually be minimal. By Armen Azizian
Trump is likely to ramp up sanctions on Iran, following his policy pre-Biden when the United States left the JCPOA and sanctioned Iran unilaterally.
