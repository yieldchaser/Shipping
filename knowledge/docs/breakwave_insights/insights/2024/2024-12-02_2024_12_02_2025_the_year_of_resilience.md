...
- section: Main
  section_type: null
  source_line: On Friday, US employment data will be closely monitored by investors.
    Whereas markets may react to the news (they usually do), investors should consider
    that if the Fed once again becomes fearful of inflation enough to delay rate cuts,
    it will likely be becaus
  unit: null
  values:
  - 2025.0
- section: Main
  section_type: null
  source_line: There are plenty of big themes we discussed recently. Within the space
    of less than 45 days we have touched upon
  unit: null
  values:
  - 45.0
regions:
