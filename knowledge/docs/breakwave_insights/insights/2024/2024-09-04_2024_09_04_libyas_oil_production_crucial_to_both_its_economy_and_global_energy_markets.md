...
- gas
date: '2024-09-04'
doc_id: breakwave_insights_insights_2024-09-04_2024_09_04_libyas_oil_production_crucial_to_both_its_economy_and_global_energy_markets
...
- section: Main
  section_type: null
  source_line: 'Libya''s oil production, crucial to both its economy and global energy
    markets, was severely disrupted last week. The country''s production has fallen
    by around 70% due to a crisis over control of the country''s central bank, while
    exports have also been halted. '
  unit: pct
  values:
  - 70.0
- section: Main
  section_type: null
  source_line: Specifically, the Sharara, El Feel, Sarir and Wafa oil fields have
    been affected by the situation, resulting in around 700,000 bpd being taken offline.
    Although the Sarir field along with Messla and Nafoura fields got instructions
    to resume operations, the out
  unit: null
  values:
  - 700000.0
- section: Main
  section_type: null
  source_line: Prior to these recent disruptions, Libya was producing around 1.2 million
    barrels per day (mbpd) (1.18mbpd in July 2024), with ambitions to increase this
    to 2.0m bpd by the mid-2020s. The country's oil is particularly valuable due to
    its high quality, making i
  unit: null
  values:
  - 1.2
  - 1.18
...
- section: Main
  section_type: null
  source_line: Libya has long struggled with internal political instability since
    the fall of Muammar Gaddafi in 2011. The country is currently divided between
    rival governments in the east and west, each backed by different militias. This
    division has made it difficult to m
  unit: null
  values:
  - 2011.0
- section: Main
  section_type: null
  source_line: 'As far as exports are concerned, Libya is primarily exporting oil
    from the Es Sider port in the eastern part of the country. In August, the country
    exported 3.9 million metric tons (mmt), while on average in 2024, it has been
    exporting 4.2 mmt per month until '
  unit: tonnage
  values:
  - 3.9
  - 2024.0
...
- section: Main
  section_type: null
  source_line: 'The fact that Libya''s main customer is so close in proximity has
    resulted in a muted reaction in the freight market, as seen in the TD21 (CrossMed)
    route last week, which fell 10% to WS 111-an unsurprising figure given the volatility
...
source_path: reports/breakwave/2024/2024-09-04_libyas-oil-production-crucial-to-both-its-economy-and-global-energy-markets.html
source_stem: 2024-09-04_libyas-oil-production-crucial-to-both-its-economy-and-global-energy-markets
source_url: https://www.breakwaveadvisors.com/insights/2024/9/4/libyas-oil-production-crucial-to-both-its-economy-and-global-energy-markets
summary: 'Main

  By Fotis Kanatas

  Libya''s oil production, crucial to both its economy and global energy markets,
  was severely disrupted last week. The country''s production has fallen by around
  70% due to a crisis over control of the country''s central bank, while exports have
  also been halted. The dispute between eastern and western political factions has
  already led to force majeure in several oil fields, according to the state-owned
...
- europe
- crude_oil
title: Libya's oil production, crucial to both its economy and global energy markets
vessel_classes:
- capesize
- panamax
- supramax
...
Main
By Fotis Kanatas
Libya's oil production, crucial to both its economy and global energy markets, was severely disrupted last week. The country's production has fallen by around 70% due to a crisis over control of the country's central bank, while exports have also been halted. The dispute between eastern and western political factions has already led to force majeure in several oil fields, according to the state-owned National Oil Corporation.
