...
- gas
date: '2021-06-23'
doc_id: breakwave_insights_insights_2021-06-23_2021_06_23_incorporating_data_driven_decision_making_in_dry_bulk_shippi
...
source_path: reports/breakwave/2021/2021-06-23_incorporating-data-driven-decision-making-in-dry-bulk-shippi.html
source_stem: 2021-06-23_incorporating-data-driven-decision-making-in-dry-bulk-shippi
source_url: https://www.breakwaveadvisors.com/insights/2021/6/23/incorporating-data-driven-decision-making-in-dry-bulk-shipping
summary: 'Main

  by Phoebus Kaloudis

  Ten years ago, the shipping industry (and most other industries for that matter)
  participants came to the realisation that it was going to be affected greatly by
  data, data capturing, data analytics and subsequently data driven decision making.
  However, as is many times the case with large disrupting events, the details on
  how it would be affected, how data was to be used, was not clear, neither was the
  timeline. Today, some 30 years since the first use of the term Big Data.'
themes:
- capesize
- brazil
- grain
...
- are
- models
title: Incorporating Data Driven Decision Making In Dry Bulk Shipping
vessel_classes:
- capesize
- panamax
- supramax
