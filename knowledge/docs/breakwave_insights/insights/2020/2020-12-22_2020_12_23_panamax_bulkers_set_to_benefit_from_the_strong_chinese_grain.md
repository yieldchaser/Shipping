...
- gas
date: '2020-12-22'
doc_id: breakwave_insights_insights_2020-12-22_2020_12_23_panamax_bulkers_set_to_benefit_from_the_strong_chinese_grain
...
source_path: reports/breakwave/2020/2020-12-23_panamax-bulkers-set-to-benefit-from-the-strong-chinese-grain.html
source_stem: 2020-12-23_panamax-bulkers-set-to-benefit-from-the-strong-chinese-grain
source_url: https://www.breakwaveadvisors.com/insights/2020/12/22/panamax-bulkers-set-to-benefit-from-the-strong-chinese-grain-demand-in-2021
summary: 'Main

  By Sevi Katemoglou

  In the midst of a generalized turmoil caused by a health crisis, subdued trading
  activity and political tensions in many fronts, we turn to grains to find some positive
  insights. It is true that this year grains have managed to "save the day" for Panamaxes
  as they proved to be a significant pillar of support for the medium-sized bulkers,
  which on many occasions ran unusually higher than the larger asset class of Capesizes.
  Although Panamax carriers'' TCE rates in 2020 so far did not manage to hit highs
  that would exceed the 2019 marks, the longhaul grain volumes somewhat offset the
  thinning trade of other major dry bulk commodities, essentially offering some comfort
  to Panamax and Kamsarmax Owners.'
themes:
- capesize
- panamax
- china
...
- iron_ore
- coal
title: Panamax Bulkers Set To Benefit From The Strong Chinese Grain Demand In 2021
vessel_classes:
- capesize
- panamax
- supramax
