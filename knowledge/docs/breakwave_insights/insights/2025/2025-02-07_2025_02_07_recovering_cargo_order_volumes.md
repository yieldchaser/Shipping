...
- steel
date: '2025-02-07'
doc_id: breakwave_insights_insights_2025-02-07_2025_02_07_recovering_cargo_order_volumes
...
- section: Main
  section_type: null
  source_line: Crude oil initially recovered some of Wednesday's losses yesterday,
    as Saudi Arabia's state oil company announced a significant price increase for
    March amid robust Chinese and Indian demand. However, further pledges of higher
    US production saw prices retreati
  unit: null
  values:
  - 74.29
  - 0.4
- section: Main
  section_type: null
  source_line: European natural gas prices extended on Wednesday's gains during yesterday's
    session as falling temperatures across parts of the continent fuelled higher demand
    and weighed on inventories. The front-month TTF futures rose by 2.0 per cent and
    settled at 54.02 e
  unit: null
  values:
  - 2.0
...
- section: Main
  ...
  source_line: The benchmark futures for the Asian and European coal markets experienced
    somewhat mixed fortunes yesterday. The March contracts for delivery in the port
    of Newcastle shed 1.1 per cent, settling at 113.50 dollars per tonne, as traders
    remained concerned over a
  unit: null
  values:
  - 1.1
  - 113.5
...
- section: Main
  section_type: null
  source_line: After some limited volatility as Chinese market participants returned
    following the Lunar New Year holidays, the iron ore prices continued to move higher
    yesterday, supported by supply disruptions. The March SGX futures ended the day
    at 105.94 dollars per tonn
  unit: null
  values:
  - 105.94
  - 2.1
- section: Main
  section_type: null
  source_line: 'The base metals rose across the board yesterday, supported by recent
    days'' downward pressure on the US dollar and supply concerns. The three-month
    LME copper futures ended yesterday''s session with a 0.4 per cent gain for the
    day, while the aluminium contracts '
  unit: null
  values:
  - 0.4
  - 1.4
...
- section: Main
  section_type: null
  source_line: 'Following losses on Wednesday, the grains and oilseeds futures listed
    on the CBOT continued to move higher yesterday. The March wheat futures recorded
    a daily gain of 2.7 per cent as traders grew concerned that cold weather in the
    Black Sea region would cause '
  unit: null
  values:
  - 2.7
  - 0.4
- section: Main
  section_type: null
  source_line: The Baltic Dry Index rose by 2.9 per cent yesterday, extending gains
    into a fifth consecutive session. It was also the first time in months that all
    of the Baltic Exchange's dry bulk indices avoided losses during the same session.
    The supramax indicator led th
  unit: null
  values:
  - 2.9
- section: Main
  section_type: null
  source_line: 'While all dry bulk gauges stayed out of the red, it did not translate
    into gains for all segments. The index for the capesizes remained unchanged for
    the session as rising tonnage supply offset robust cargo order volumes in the
    Atlantic. The indicator for the '
  unit: null
  values:
  - 4.1
  - 4.8
...
- section: Main
  section_type: null
  source_line: The Baltic Exchange's wet freight indices recorded modest moves during
    yesterday's session. The dirty and clean tanker indicators rose by 0.3 and 0,7
    per cent, respectively. The spot gauge for the LNG carriers remained unchanged
    for a second day, while the LPG
  unit: null
  values:
  - 0.3
  - 7.0
...
- section: Main
  section_type: null
  source_line: After mostly limited gains on Wednesday, the bunker fuels faced renewed
    pressure yesterday amid lower crude oil prices. The VLSFO shed 1.3 per cent in
    Rotterdam while retreating by 1.2 per cent in Singapore and 0.6 per cent in Houston.
    Developments for the MGO
  unit: null
  values:
  - 1.3
  - 1.2
...
- section: Main
  section_type: null
  source_line: As highlighted in recent editions of "The Fix", cargo order volumes
    for dry bulk commodities discharging in Chinese ports have experienced a slow
    start to the year. Compared to the past two years, the aggregate cargo order volumes
    for spot dry bulk imports wer
  unit: null
  values:
  - 2023.0
- section: Main
  section_type: null
  source_line: 'Image reference: Στιγμιότυπο οθόνης 2025-02-07 143307.png | assets/2025-02-07_recovering-cargo-order-volumes_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_c7ee8edca4c8.png'
  unit: null
  values:
  - 2025.0
  - -2.0
  ...
  - 4.0
  - 5.0
- section: 'Linked asset: 2025-02-07_recovering-cargo-order-volumes_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_c7ee8edca4c8.png'
  section_type: linked_image_asset
  source_line: 'Linked image asset: 2025-02-07_recovering-cargo-order-volumes_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_c7ee8edca4c8.png'
  unit: null
  values:
  - 2025.0
  - -2.0
...
- section: 'Linked asset: 2025-02-07_recovering-cargo-order-volumes_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_c7ee8edca4c8.png'
  section_type: linked_image_asset
  source_line: 'Image metadata: PNG 651x376 mode=RGBA'
  unit: null
  values:
  - 651.0
  - 76.0
...
source_path: reports/breakwave/2025/2025-02-07_recovering-cargo-order-volumes.html
source_stem: 2025-02-07_recovering-cargo-order-volumes
source_url: https://www.breakwaveadvisors.com/insights/2025/2/7/recovering-cargo-order-volumes
summary: 'Main

  The Baltic Dry Index advanced for a fifth consecutive session on Thursday, with
  all vessel segments avoiding the red. Recovering cargo order volumes across the
  major basins contributed to healthy gains for the mid and small-sized vessels. The
  commodities generally ended the day higher, but Newcastle coal and crude oil defied
  the trend and posted limited losses.'
themes:
- capesize
- panamax
- supramax
...
- lng
- lpg
title: Recovering cargo order volumes
vessel_classes:
- capesize
- panamax
- supramax
...
Image reference: Στιγμιότυπο οθόνης 2025-02-07 143307.png | assets/2025-02-07_recovering-cargo-order-volumes_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_c7ee8edca4c8.png
Data Source: Shipfix

## Linked asset: 2025-02-07_recovering-cargo-order-volumes_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_c7ee8edca4c8.png
Source asset: reports/breakwave/2025/assets/2025-02-07_recovering-cargo-order-volumes_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_c7ee8edca4c8.png

Linked image asset: 2025-02-07_recovering-cargo-order-volumes_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_c7ee8edca4c8.png

Image metadata: PNG 651x376 mode=RGBA
