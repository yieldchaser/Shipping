...
- gas
date: '2025-10-31'
doc_id: breakwave_insights_insights_2025-10-31_2025_10_31_imo_net_zero_framework_delay_and_the_ussaudi_alliance
...
- section: Main
  section_type: null
  source_line: 'Image reference: Στιγμιότυπο οθόνης 2025-10-31 101657.png | assets/2025-10-31_imo-net-zero-framework-delay-and-the-ussaudi-alliance_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_92ebd3d09621.png'
  unit: null
  values:
  - 2025.0
  - -10.0
...
- section: Main
  section_type: null
  source_line: The decision, reached during the second Extraordinary Session of the
    Marine Environment Protection Committee (MEPC/ ES.2) in October 2025, followed
    the failure of member states to agree on a global greenhouse-gas (GHG) pricing
    mechanism, the NZF's central poli
  unit: null
  values:
  - 2.0
  - 2025.0
- section: Main
  section_type: null
  source_line: The framework will now be reconsidered at the next MEPC session in
    October 2026, delaying the earliest feasible entryinto-force date to 1 March 2028,
    according to DNV's regulatory analysis. This shift reflects not only procedural
    timelines under the IMO's taci
  unit: null
  values:
  - 2026.0
  - 1.0
...
- section: Main
  section_type: null
  source_line: 'In the interim, the IMO''s 2023 Greenhouse Gas Strategy remains in
    force, committing the sector to achieve net-zero GHG emissions by or around 2050.
    However, in the absence of a globally harmonized carbon-pricing mechanism, the
...
- section: Main
  section_type: null
  source_line: During the MEPC/ES.2 session, member states agreed that additional
    technical preparation was required before formal adoption, establishing a new
    target of October 2026 for approval and March 2028 for entry into force.
  unit: null
  values:
  - 2.0
  - 2026.0
...
- section: Main
  section_type: null
  source_line: The October 2025 session was influenced by alignment between the United
    States and Saudi Arabia, which opposed the introduction of a binding global carbon
    levy. The U.S. delegation argued that the measure was incompatible with its domestic
    policy framework. At
  unit: null
  values:
  - 2025.0
- section: Main
  section_type: null
  source_line: The U.S.-Saudi stance reflected shared economic priorities, not a change
    in their decarbonization goals. Both governments maintain public commitments to
    emissions reduction. Washington, through port electrification and infrastructure
    programs, and Riyadh, thro
  unit: null
  values:
  - 2030.0
- section: Main
  section_type: null
  source_line: While global adoption of the IMO's Net-Zero Framework has been deferred,
    regional and national initiatives are moving ahead independently. The European
    Union integrated maritime transport into its Emissions Trading System (ETS) in
    January 2024, introducing a c
  unit: null
  values:
  - 2024.0
  - 2026.0
- section: Main
  section_type: null
  source_line: 'In the United States, federal policy continues to reject a national
    carbon price but channels significant infrastructure funding toward maritime decarbonisation
    through the Port Infrastructure Development Program (PIDP), which supports shore
    power systems and '
  unit: null
  values:
  - 2030.0
- section: Main
  section_type: null
  source_line: In commercial practice, vessels equipped with dual-fuel or methanol-ready
    capability are attracting growing charter interest, particularly on routes subject
    to regional carbon pricing. Shipowners and charterers view such tonnage as a practical
    hedge against fu
  unit: null
  values:
  - 2022.0
...
- section: Main
  section_type: null
  source_line: Between 2025 and 2026, IMO working groups will finalise the technical
    documentation defining the operation of the NetZero Framework (NZF). These documents
    will set out the methods for calculating fuel-intensity, verifying emissions data,
...
- section: Main
  section_type: null
  source_line: The decision at MEPC/ES.2 constitutes a twelve-month postponement of
    the IMO's Net-Zero Framework (NZF) rather than a change in policy direction. While
    the 2050 net-zero target remains intact, the delay is already influencing fleetmanagement
    behaviour. The mos
  unit: null
  values:
  - 2.0
...
- section: Main
  section_type: null
  source_line: During this interim period, the industry's focus is shifting from policy
    debate to operational readiness. Maintaining verified DCS reporting, investing
    in fuel-flexible tonnage, and preparing for future carbon-cost mechanisms will
    define competitiveness once t
  unit: null
  values:
  - 2028.0
- section: 'Linked asset: 2025-10-31_imo-net-zero-framework-delay-and-the-ussaudi-alliance_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_92ebd3d09621.png'
  section_type: linked_image_asset
  source_line: 'Linked image asset: 2025-10-31_imo-net-zero-framework-delay-and-the-ussaudi-alliance_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_92ebd3d09621.png'
  unit: null
  values:
  - 2025.0
  - -10.0
...
- section: 'Linked asset: 2025-10-31_imo-net-zero-framework-delay-and-the-ussaudi-alliance_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_92ebd3d09621.png'
  section_type: linked_image_asset
  source_line: 'Image metadata: PNG 912x620 mode=RGBA'
  unit: null
  values:
  - 912.0
  - 20.0
...
source_path: reports/breakwave/2025/2025-10-31_imo-net-zero-framework-delay-and-the-ussaudi-alliance.html
source_stem: 2025-10-31_imo-net-zero-framework-delay-and-the-ussaudi-alliance
source_url: https://www.breakwaveadvisors.com/insights/2025/10/31/imo-net-zero-framework-delay-and-the-ussaudi-alliance
summary: 'Main

  Image reference: Στιγμιότυπο οθόνης 2025-10-31 101657.png | assets/2025-10-31_imo-net-zero-framework-delay-and-the-ussaudi-alliance_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_92ebd3d09621.png

  Executive Overview

  The International Maritime Organization (IMO) has postponed the adoption of its
  Net-Zero Framework (NZF) by one year, reflecting persistent geopolitical and economic
  divisions over how to govern shipping''s decarbonization. The decision, reached
  during the second Extraordinary Session of the Marine Environment Protection Committee
  (MEPC/ ES.2) in October 2025, followed the failure of member states to agree on
  a global greenhouse-gas (GHG) pricing mechanism, the NZF''s central policy instrument.
  Officially, the IMO framed the adjournment as a procedural extension to allow further
  "technical and procedural work." In practice, the deadlock exposed deep structural
  disagreements over how the revenues of a global carbon levy should be designed,
  distributed, and managed across regions.'
themes:
- capesize
- container
- china
...
- japan
- coal
title: IMO Net-Zero Framework Delay and the U.S.-Saudi Alliance
vessel_classes:
- capesize
- panamax
- supramax
...
## Linked asset: 2025-10-31_imo-net-zero-framework-delay-and-the-ussaudi-alliance_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_92ebd3d09621.png
Source asset: reports/breakwave/2025/assets/2025-10-31_imo-net-zero-framework-delay-and-the-ussaudi-alliance_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_92ebd3d09621.png

Linked image asset: 2025-10-31_imo-net-zero-framework-delay-and-the-ussaudi-alliance_img_cea3cf84ceb9ceb3cebcceb9cf8ccf84cf85_92ebd3d09621.png

Image metadata: PNG 912x620 mode=RGBA
