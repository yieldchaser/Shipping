...
- gas
date: '2025-07-31'
doc_id: breakwave_insights_insights_2025-07-31_2025_07_31_southbound_crude_transits_via_bab_el_mandeb_ease_on_rising_s
...
- section: Renewed attacks and softer demand trim BEM crude flows
  section_type: null
  source_line: 'On 6 and 7 July, Houthi forces launched renewed attacks in the Red
    Sea, this time striking bulk carriers. While tankers were not directly impacted,
    the incidents have reignited security concerns among shipowners operating in the
    region-particularly those with '
  unit: null
  values:
  - 6.0
  - 7.0
...
- section: Renewed attacks and softer demand trim BEM crude flows
  section_type: null
  source_line: Russian Urals continue to dominate southbound crude flows via Bab-el-Mandeb,
    accounting for an estimated 75% of volumes between January 2024 and July 2025.
    The majority of these cargoes discharge into India, with around 9% heading to
    China. However, Indian ref
  unit: worldscale_pct
  values:
  - 75.0
  - 2024.0
...
- section: Renewed attacks and softer demand trim BEM crude flows
  section_type: null
  source_line: The cost of transiting BEM has also risen sharply, with Additional
    War Risk Premiums (AWRP) now around 0.7% of hull & machinery, up from 0.25-0.4%
    earlier this year, according to Argus. Many owners still prefer BEM for its shorter
    routing, but recent diversion
  unit: pct
  values:
  - 0.7
  - 0.25
  - -0.4
- section: Strategic Pullback in Greek Participation
  section_type: null
  source_line: Weekly voyage counts by Greek operators in moving Russian crude via
    BEM peaked in Q2 2023-coinciding with a period when Urals was trading below the
    G7 price cap. A similar uptick occurred in January 2025, when prices once again
    fell below the cap and a new wav
  unit: null
  values:
  - 2023.0
  - 2025.0
- section: Strategic Pullback in Greek Participation
  section_type: null
  source_line: Since mid-2023, however, this participation has been on a gradual decline.
    Three weeks on from the July attacks, southbound transits via BEM have continued,
    with only a handful of diversions recorded so far. Should the attack resume, up
    to 20% of the fleet wit
  unit: worldscale_pct
  values:
  - 2023.0
  - 20.0
...
source_path: reports/breakwave/2025/2025-07-31_southbound-crude-transits-via-bab-el-mandeb-ease-on-rising-s.html
source_stem: 2025-07-31_southbound-crude-transits-via-bab-el-mandeb-ease-on-rising-s
source_url: https://www.breakwaveadvisors.com/insights/2025/7/31/southbound-crude-transits-via-bab-el-mandeb-ease-on-rising-security-risk
summary: 'Main

  July saw a dip in southbound crude transits via Bab-el-Mandeb as renewed Red Sea
  attacks, and growing compliance pressures prompted selective rerouting and owner
  caution. By Wanying Zhang


  Renewed attacks and softer demand trim BEM crude flows

  On 6 and 7 July, Houthi forces launched renewed attacks in the Red Sea, this time
  striking bulk carriers. While tankers were not directly impacted, the incidents
  have reignited security concerns among shipowners operating in the region-particularly
  those with exposure to Bab-el-Mandeb (BEM) transits.'
themes:
- capesize
- suezmax
- china
...
- pacific
- europe
title: Southbound Crude Transits Via Bab El Mandeb Ease On Rising Security Risk
vessel_classes:
- capesize
- panamax
- supramax
...
## Summary
Main
July saw a dip in southbound crude transits via Bab-el-Mandeb as renewed Red Sea attacks, and growing compliance pressures prompted selective rerouting and owner caution. By Wanying Zhang

Renewed attacks and softer demand trim BEM crude flows
On 6 and 7 July, Houthi forces launched renewed attacks in the Red Sea, this time striking bulk carriers. While tankers were not directly impacted, the incidents have reignited security concerns among shipowners operating in the region-particularly those with exposure to Bab-el-Mandeb (BEM) transits.
