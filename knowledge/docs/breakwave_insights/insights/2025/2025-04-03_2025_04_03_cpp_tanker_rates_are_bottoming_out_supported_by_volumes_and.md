...
- gas
date: '2025-04-03'
doc_id: breakwave_insights_insights_2025-04-03_2025_04_03_cpp_tanker_rates_are_bottoming_out_supported_by_volumes_and
...
source_path: reports/breakwave/2025/2025-04-03_cpp-tanker-rates-are-bottoming-out-supported-by-volumes-and.html
source_stem: 2025-04-03_cpp-tanker-rates-are-bottoming-out-supported-by-volumes-and
source_url: https://www.breakwaveadvisors.com/insights/2025/4/3/cpp-tanker-rates-are-bottoming-out-supported-by-volumes-and-distances
summary: 'Main

  Key takeaways from this report:

  Dirty - East of Suez: Shift from long-haul to regional flows supports Suezmax utilisation
  and rate rebound

  Clean - East of Suez: Soft demand weighs on clean tankers in recent quarters, but
  rates trajectory seems to bottom out

  Dirty - West of Suez: Tightening tonnage in Gulf of Mexico and higher employment
  in Canada EC boost Aframax rates, for now

  Clean - West of Suez: Rising NW Europe CPP loadings push TC2 rates up to six-month
  highs

  By Ioannis Papadimitriou

  Before the invasion, Pacific Basin demand was partially met by longerhaul Suezmax
  voyages from Wide Arabian Sea and South Atlantic

  The Russia-Ukraine war triggered a structural shift in trade flows as discounted
  Russian crude flooded Asia, displacing West Africa and Middle Eastern barrels

  ➔ This readjustment led to a steady decline in average Suezmax voyage mileage

  Recently, India and China emerged as regional buyers of accessible barrels from
  the MEG and the Atlantic

  ➔ Supported by FOB terms, buyers split VLCC stems into Suezmaxes when VLCC supply
  is tight to retain scheduling flexibility

  ➔ Uptick in Suezmax liftings from MEG to WCI contributing to sustained fleet utilisation,
  pushed voyage'
themes:
- vlcc
- suezmax
...
- atlantic
- pacific
title: Cpp Tanker Rates Are Bottoming Out Supported By Volumes And Distances
vessel_classes:
- capesize
- panamax
- supramax
...
➔ Uptick in Suezmax liftings from MEG to WCI contributing to sustained fleet utilisation, pushed voyage
