...
- steel
date: '2025-12-04'
doc_id: breakwave_insights_insights_2025-12-04_2025_12_05_rising_australian_ore_loadings_keep_upward_pressure_on_wachi
...
- section: Main
  section_type: null
  source_line: C5 assessments have climbed back to the peak levels last seen in 4Q23,
...
- section: Main
  section_type: null
  source_line: Iron ore stockpiles across China's 45 major ports (tracked by Mysteel)
    increased by 1.6 million tonnes, or 1%, in the week of Nov 21-27, reaching 152.1
    million tonnes, the highest level in nine months and 1% above last year's level,
    marking the first year-on-y
  unit: pct
  values:
  - 45.0
  - 1.6
...
- section: Main
  section_type: null
  source_line: 'Seasonal High: China''s Iron Ore Intake from Western Australia exceeded
    70M mt in Q4'
  unit: tonnage
  values:
  - 70.0
- section: Main
  section_type: null
  source_line: Port Hedland | Capesize Iron Ore Exports to China Exceeded 33million
    metric tonnes in November
  unit: null
  values:
  - 33.0
- section: Main
  section_type: null
  source_line: In November, Port Hedland's Capesize iron ore shipments to China climbed
    past 33 million metric tons, coming close to the May high of more than 35 million
    tons. Dampier and Port Walcott added meaningful volumes as well, but Port Hedland
    remained dominant, repr
  unit: pct
  values:
  - 33.0
  - 35.0
...
- section: Main
  section_type: null
  source_line: Ballaster availability has tightened, with the 21D MA dropping to 162
    vessels
  unit: null
  values:
  - 21.0
...
- section: Main
  section_type: null
  source_line: 'Ballaster numbers have retreated significantly from their early-October
    peak of roughly 180 vessels to around 160 by late November. This decline aligns
    with the pick-up in iron ore loadings out of Western Australia, which has helped
    absorb the excess tonnage. '
  unit: tonnage
  values:
  - 180.0
  - 160.0
...
- section: Main
  section_type: null
  source_line: Pilbara miners continue to upgrade and digitalise their supply chains,
    from Rio Tinto's US$733m West Angelas investment to recent AI-driven rail efficiency
    gains, strengthening the underlying infrastructure that enables stable production
    and shipment capabilit
  unit: usd
  values:
  - 733.0
- section: Main
  section_type: null
  source_line: 'Q1 26: Short-Term Downside Risks'
  unit: null
  values:
  - 26.0
regions:
...
source_path: reports/breakwave/2025/2025-12-05_rising-australian-ore-loadings-keep-upward-pressure-on-wachi.html
source_stem: 2025-12-05_rising-australian-ore-loadings-keep-upward-pressure-on-wachi
source_url: https://www.breakwaveadvisors.com/insights/2025/12/4/rising-australian-ore-loadings-keep-upward-pressure-on-wachina-freight
summary: 'Main

  In our previous market insights, we explored the Simandou iron ore story and whether
  it could meaningfully challenge the long-standing dominance of Australian and Brazilian
  exporters. This week, we shift focus to Western Australia''s iron ore dynamics behind
  the recent strength in the C5 freight route assessment. With year-end approaching,
  we review how shipment volumes have evolved and whether Q4 is on track to deliver
  a firm close for Australia''s iron ore industry.'
themes:
- capesize
- china
- brazil
...
- pacific
- iron_ore
title: Rising Australian Ore Loadings Keep Upward Pressure On Wachina Freight
vessel_classes:
- capesize
- panamax
- supramax
...
Spotlight on West Australian Iron Ore Flows | China
