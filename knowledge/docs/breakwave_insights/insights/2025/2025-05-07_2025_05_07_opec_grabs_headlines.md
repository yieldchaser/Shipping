...
- gas
date: '2025-05-07'
doc_id: breakwave_insights_insights_2025-05-07_2025_05_07_opec_grabs_headlines
...
- section: Main
  ...
  source_line: The global oil market has been riding through intense swings, with
    ...
    to handle a stretch of lower prices. This isn't happening in isolation. OPEC+,
    spearheaded by Saudi Arabia an
  unit: pct
  values:
  - 6.85
  - 411000.0
- section: Main
  section_type: null
  source_line: 'Yet, while OPEC+ grabs headlines, it''s important to remember that
    non-OPEC producers now provide nearly 60% of global oil - suggesting their share
    may have plateaued if extra barrels push prices further down. For Saudi Arabia,
    the strategy is twofold: it puts '
  unit: pct
  values:
  - 60.0
- section: Main
  section_type: null
  source_line: Estimations have been quick to react. Barclays, for instance, cut its
    Brent forecast for 2025 by $4, landing at $66 per barrel, while ING now expects
    an average of $65 this year, down from $70. These downward revisions reflect not
    just the rising supply but al
  unit: usd
  values:
  - 2025.0
  - 4.0
...
source_path: reports/breakwave/2025/2025-05-07_opec-grabs-headlines.html
source_stem: 2025-05-07_opec-grabs-headlines
source_url: https://www.breakwaveadvisors.com/insights/2025/5/7/opec-grabs-headlines
summary: 'Main

  By Yiannis Parganas

  The global oil market has been riding through intense swings, with Brent crude tumbling
  6.85% just last week after Saudi Arabia signaled it''s prepared to handle a stretch
  of lower prices. OPEC+, spearheaded by Saudi Arabia and Russia, has committed to
  ramping up production for a second month in a row, adding another 411,000 barrels
  per day (bpd) in June. Altogether, by the end of the April-June window, nearly a
  million bpd will have returned to the market.'
themes:
- lng
- china
- europe
