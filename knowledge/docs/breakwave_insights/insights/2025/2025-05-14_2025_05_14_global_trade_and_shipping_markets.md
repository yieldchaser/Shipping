...
- gas
date: '2025-05-14'
doc_id: breakwave_insights_insights_2025-05-14_2025_05_14_global_trade_and_shipping_markets
...
- section: Main
  section_type: null
  source_line: Last weekend brought encouraging news for global trade and shipping
    markets, as progress on two key fronts helped ease geopolitical tensions and lift
    market sentiment. In Geneva, the United States and China announced a 90-day reciprocal
    tariff reduction agreem
  unit: null
  values:
  - 90.0
- section: Main
  section_type: null
  source_line: The U.S.-China agreement entails a mutual rollback of tariffs, effective
    May 14, with the U.S. reducing duties on Chinese imports to 30% and China lowering
    tariffs on U.S. goods to 10%. While not a comprehensive resolution to the ongoing
    trade conflict, this s
  unit: worldscale_pct
  values:
  - 14.0
  - 30.0
...
- section: Main
  section_type: null
  source_line: The Containership sector is expected to be one of the main beneficiaries
    of this development. The easing of trade barriers is estimated to trigger a short-term
    recovery in transpacific trade volumes, which have been impacted by the imposition
    of tariffs, leadi
  unit: null
  values:
  - 90.0
...
source_path: reports/breakwave/2025/2025-05-14_global-trade-and-shipping-markets.html
source_stem: 2025-05-14_global-trade-and-shipping-markets
source_url: https://www.breakwaveadvisors.com/insights/2025/5/14/global-trade-and-shipping-markets
summary: 'Main

  By Nikolaos Tagoulis

  Last weekend brought encouraging news for global trade and shipping markets, as
  progress on two key fronts helped ease geopolitical tensions and lift market sentiment.
  In Geneva, the United States and China announced a 90-day reciprocal tariff reduction
  agreement, while reports of truce between India and Pakistan, mediated by the United
  Stets, signaled a potential de-escalation of hostilities in the Indian Subcontinent.
  Together, these developments offer a welcome reprieve for the global trade and shipping
  amid uncertainty, shaped by geopolitical risks and trade frictions.'
themes:
- lng
- container
- china
...
- meg
- europe
title: Global trade and shipping markets
vessel_classes:
- capesize
- panamax
- supramax
