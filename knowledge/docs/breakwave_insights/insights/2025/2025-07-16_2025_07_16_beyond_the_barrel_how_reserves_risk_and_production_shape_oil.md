...
- gas
date: '2025-07-16'
doc_id: breakwave_insights_insights_2025-07-16_2025_07_16_beyond_the_barrel_how_reserves_risk_and_production_shape_oil
...
- section: Main
  section_type: null
  source_line: 'Top Ranking Countries : Venezuela remains the world''s largest holder
    of proven oil reserves (approximately 304 billion barrels), followed by Saudi
    Arabia (approximately 297 billion barrels). Iran holds approximately 209 billion
    barrels, while Canada possesses '
  unit: null
  values:
  - 304.0
  - 297.0
...
- section: Main
  section_type: null
  source_line: 'Red Sea Threats: Recent Houthi attacks on merchant vessels in the
    Bab el-Mandeb Strait, including fatal strikes on Greek-owned ships in early July,
    have significantly elevated marine insurance premiums, now exceeding 0.7 percent
    of vessel value, with some quot'
  unit: pct
  values:
  - 0.7
  - 1.0
...
- section: Main
  section_type: null
  source_line: Saudi Arabia's exports have already exceeded 7.5 million barrels per
    day. At the same time, OPEC+ has been gradually unwinding its voluntary production
    cuts since April, beginning with an increase of 138,000 barrels per day, followed
    by monthly additions of 41
  unit: null
  values:
  - 7.5
  - 138000.0
...
- section: Main
  section_type: null
  source_line: Meanwhile, the International Energy Agency projects global oil supply
    to grow by 2.1 million barrels per day in 2025, significantly outpacing expected
    demand growth of just 700,000 barrels per day. This would mark the slowest annual
    increase in demand since 20
  unit: null
  values:
  - 2.1
  - 2025.0
...
- section: Main
  section_type: null
  source_line: 'Regional Price Divergence: Price spreads between crude grades remain
    pronounced. Light, sweet crudes such as Bonny Light continue to command a premium
    over Brent, supported by low sulfur content and strong yields of gasoline and
    diesel. In contrast, heavier Ca'
  unit: usd
  values:
  - 10.0
- section: Main
  section_type: null
  source_line: Brent crude has retreated from mid-June highs (approximately 74 dollars)
    to around 70 to 71 dollars, while WTI hovers near 68.5 dollars. Analysts expect
    a rangebound price environment in the short term as geopolitical risks (Red Sea,
    Strait of Hormuz, sanction
  unit: null
  values:
  - 74.0
  - 70.0
...
- section: Main
  section_type: null
  source_line: Strategic reserves continue to serve as critical geopolitical buffers,
    released during supply shocks to stabilize markets. The United States maintains
    one of the world's largest Strategic Petroleum Reserves (SPR), but recent years
    of drawdowns combined with un
  unit: null
  values:
  - 2025.0
  - 3.0
...
- section: Main
  section_type: null
  source_line: While commercial inventories showed signs of recovery earlier this
    year, recent IEA data from June confirms that OECD stocks remain 97 million barrels
    below 2023 levels. Markets remain highly sensitive to SPR activity, with oil price
    volatility frequently resp
  unit: null
  values:
  - 97.0
  - 2023.0
...
source_path: reports/breakwave/2025/2025-07-16_beyond-the-barrel-how-reserves-risk-and-production-shape-oil.html
source_stem: 2025-07-16_beyond-the-barrel-how-reserves-risk-and-production-shape-oil
source_url: https://www.breakwaveadvisors.com/insights/2025/7/16/beyond-the-barrel-how-reserves-risk-and-production-shape-oil-trade
summary: 'Production

  In energy economics, proven oil reserves refer to quantities of crude oil that geological
  and engineering data demonstrate with reasonable certainty to be recoverable under
  existing economic and operational conditions. Reserves should not be confused with
  production. While reserves represent potential, production refers to actual extraction
  volumes brought to market.'
themes:
- capesize
- china
- brazil
...
- japan
- crude_oil
title: Beyond The Barrel How Reserves Risk And Production Shape Oil Trade
vessel_classes:
- capesize
- panamax
- supramax
...
## Summary
Production
In energy economics, proven oil reserves refer to quantities of crude oil that geological and engineering data demonstrate with reasonable certainty to be recoverable under existing economic and operational conditions. Reserves should not be confused with production. While reserves represent potential, production refers to actual extraction volumes brought to market.
