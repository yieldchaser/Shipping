...
- gas
date: '2025-03-13'
doc_id: breakwave_insights_insights_2025-03-13_2025_03_13_chevron_licence_revocation_could_hurt_aframax_rates_in_ec_am
...
- section: Main
  section_type: null
  source_line: After a declining H2 2024, global VLCC demand rebounded, with utilisation
    climbing over 50% since the start of 2025
  unit: pct
  values:
  - 2024.0
  - 50.0
...
- section: Main
  section_type: null
  source_line: ➔ VLCC TD3C (Middle East-to-East) and TD15 (West Africa-toEast) are
    showing a similar trajectory
  unit: null
  values:
  - 5.0
- section: Main
  section_type: null
  source_line: ➔ US tariffs on China and the current geopolitical climate have driven
    a softening on TD22 (US Gulf-to-East) rates
  unit: null
  values:
  - 2.0
- section: Main
  section_type: null
  source_line: Even with the India-led February uptick, total voyages via the Red
    Sea remain well short of pre-2024 levels, and a recent increase in tensions between
    Israel-Palestine may prompt a resumption in Houthi attacks on vessels linked to
    western/Israeli trading activ
  unit: null
  values:
  - 2024.0
- section: Main
  section_type: null
  source_line: Since the US waiver on Venezuelan crude expired in May 2024, 18 Aframax
    vessels had been actively engaged in this trade
  unit: null
  values:
  - 2024.0
  - 18.0
- section: Main
  section_type: null
  source_line: ➔ On average, 12 voyages per month have been loading out of Venezuela
    and heading to the US, specifically on this trade route
  unit: null
  values:
  - 12.0
- section: Main
  section_type: null
  source_line: ➔ There is no clear indication yet that vessels are leaving the Venezuela
    trade as of now, among the 8 ballasting vessels, 5 are declaring Venezuela as
    their destination
  unit: null
  values:
  - 8.0
...
- section: Main
  section_type: null
  source_line: Employment of MRs lifting CPP cargoes out of Russia have fallen by
    30% month-on-month in February, maintaining a weakening growth momentum since
    late 2024
  unit: pct
  values:
  - 30.0
...
- section: Main
  section_type: null
  source_line: ➔ This is an implication of Russian oil exports (with exception of
    diesel) declining at approx. 500kbd year-on-year
  unit: null
  values:
  - 500.0
regions:
...
source_path: reports/breakwave/2025/2025-03-13_chevron-licence-revocation-could-hurt-aframax-rates-in-ec-am.html
source_stem: 2025-03-13_chevron-licence-revocation-could-hurt-aframax-rates-in-ec-am
source_url: https://www.breakwaveadvisors.com/insights/2025/3/13/chevron-licence-revocation-could-hurt-aframax-rates-in-ec-americas
summary: 'Main

  Key takeaways from this report:

  Dirty - East of Suez: VLCC utilisation back up, but uncertainties on a rally continuation
  are looming

  Clean - East of Suez: India exports quickest to respond to reduced risks for Red
  Sea transits for E-W middle distillate flows

  Dirty - West of Suez: Chevron licence revocation could dampen Aframax in the US
  market

  Clean - West of Suez: Weak growth momentum continues for Russia MRs as Russia CPP
  exports (excl. diesel) degrade

  By Ioannis Papadimitriou

  After a declining H2 2024, global VLCC demand rebounded, with utilisation climbing
  over 50% since the start of 2025

  ➔ Increasing VLCC fixing activity from the Atlantic Basin supported rates during
  this period

  ➔ China and India, buyers of Russian crude grades, were seeking alternative crude
  supplies after the US imposed sanctions on Russian-trading vessels

  However, utilisation has plateaued since the start of February

  ➔ VLCC TD3C (Middle East-to-East) and TD15 (West Africa-toEast) are showing a similar
  trajectory

  ➔ This could indicate that India and China are trying to find ways to secure discounted
  barrels, despite OPEC''s announcement of unwinding production cuts

  ➔ Turkey''s decision to reduce exposure'
themes:
- vlcc
- aframax
- china
...
- meg
- west_africa
title: Chevron Licence Revocation Could Hurt Aframax Rates In Ec Americas
vessel_classes:
- capesize
- panamax
- supramax
