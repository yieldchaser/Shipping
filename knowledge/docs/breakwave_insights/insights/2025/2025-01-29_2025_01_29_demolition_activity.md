...
- steel
date: '2025-01-29'
doc_id: breakwave_insights_insights_2025-01-29_2025_01_29_demolition_activity
...
- section: Main
  section_type: null
  source_line: Building on our previous report, in which we analyzed the projected
    bulk carrier deliveries for 2025, and considering the current downturn in the
    freight market, an increase in demolition activity could serve as a positive development
    within the ship-owning in
  unit: null
  values:
  - 2025.0
  - 2025.0
- section: Main
  section_type: null
  source_line: The strong freight market conditions of recent years have led to an
    increase in the average age of bulk carriers, which now stands at 12.5 years-the
    highest level recorded since January 2011. Specifically, the Handysize sector
    has reached an average age of 13.
  unit: pct
  values:
  - 2011.0
  - 9.0
...
- section: Main
  section_type: null
  source_line: Examining the market dynamics of 2016, it is evident that the price
    premium of 20-year-old vessels over their scrap value was at a record low. For
    instance, in the Handymax/Supramax segment-which is expected to see the highest
    number of new deliveries in 2025-
  unit: usd
  values:
  - 2016.0
  - 20.0
...
- section: Main
  section_type: null
  source_line: The average scrap prices offered by Bangladeshi scrapyards currently
    hover around the mid-$400/ldt range, with further declines anticipated. Several
    factors contribute to this downward trend, including low steel margins, the influx
    of inexpensive imported Chin
  unit: usd
  values:
  - 400.0
regions:
...
source_path: reports/breakwave/2025/2025-01-29_demolition-activity.html
source_stem: 2025-01-29_demolition-activity
source_url: https://www.breakwaveadvisors.com/insights/2025/1/29/demolition-activity
summary: 'Main

  By Yiannis Parganas

  Building on our previous report, in which we analyzed the projected bulk carrier
  deliveries for 2025, and considering the current downturn in the freight market,
  an increase in demolition activity could serve as a positive development within
  the ship-owning industry. Among the two conventional sectors, the dry bulk market
  is currently experiencing a challenging environment, marked by weak demand and anticipated
  vessel deliveries that will lead to fleet growth surpassing the estimated tonnage
  demand growth for 2025. In this context, any rise in demolition activity within
  this sector could offer relief to the shipping industry.'
themes:
- capesize
- panamax
- supramax
