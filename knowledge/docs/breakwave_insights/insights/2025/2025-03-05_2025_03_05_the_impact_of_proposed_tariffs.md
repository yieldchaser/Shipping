...
- gas
date: '2025-03-05'
doc_id: breakwave_insights_insights_2025-03-05_2025_03_05_the_impact_of_proposed_tariffs
...
source_path: reports/breakwave/2025/2025-03-05_the-impact-of-proposed-tariffs.html
source_stem: 2025-03-05_the-impact-of-proposed-tariffs
source_url: https://www.breakwaveadvisors.com/insights/2025/3/5/the-impact-of-proposed-tariffs
summary: 'Main

  By Yiannis Parganas

  Following the announcement of proposed tariffs on Chinese-built and operated vessels,
  the immediate impact remains zero, as the measures are still under discussion. However,
  if implemented, the number of affected vessels would be massive, potentially disrupting
  global shipping, increasing costs, and reshaping trade routes on a significant scale.
  To give a full picture, 41.5% of the total inservice fleet was built in Chinese
  shipyards, including 22.2% of the global tanker fleet, 32.2% of the container fleet,
  and 11.6% of the gas fleet.'
themes:
- lng
- lpg
- container
...
- japan
- crude_oil
title: The Impact Of Proposed Tariffs
vessel_classes:
- capesize
- panamax
- supramax
