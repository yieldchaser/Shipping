...
- gas
date: '2025-01-29'
doc_id: breakwave_insights_insights_2025-01-29_2025_01_29_uncertainty_vs_volatility_and_the_difference_between_flows_a
...
- section: Main
  section_type: null
  source_line: The 2020s have been fraught with turbulences, including amid others
    the Covid-related demand shock, the steep recovery afterwards coinciding with
    the start of the Russia-Ukraine war, and the subsequent massive changes in global
    trade flows due to sanctions.
  unit: null
  values:
  - 2020.0
- section: Main
  section_type: null
  source_line: Up to late 2022, these turbulences were also reflected in wide fluctuations
    of oil prices, stretching over a price band of more than $100/b, expanding a highly
    volatile period from 2004 onwards. However, since early 2023, oil barely traded
    outside a narrow $15
  unit: usd
  values:
  - 2022.0
...
- section: Main
  section_type: null
  source_line: 'Before answering that question, let us look at the key factors behind
    stable prices: a mix of limited demand growth and supply-side flexibility. As
    for the latter, OPEC+ has been very successful in restraining supplies over the
    last two years. In February 2023'
  unit: null
  values:
  - 2023.0
- section: Main
  section_type: null
  source_line: Many forecasters suggest 2025 oil prices to be (marginally) lower than
    in 2024 ( John Kemp survey ), with most projections located in a narrow range,
    suggesting even lower volatility in times of high uncertainty. The pressure on
    prices stems from strong non-OP
  unit: null
  values:
  - 2025.0
  - 2024.0
...
- section: Main
  section_type: null
  source_line: We have established above that overall supply/demand levels as observed
    in imports and exports have been pretty stable over the last two years. But the
    story is very different for the freight market, that is when it comes to the question
    of from where to where
  unit: null
  values:
  - 2024.0
- section: Main
  section_type: null
  source_line: More recently we have seen a huge reshuffling of middle distillate
    flows out of the Wider Arabian Sea (including in particular the Middle East Gulf,
    the Red Sea and the west coast of India). Flows to the Pacific Basin (including
    the regional Arabian Sea market
  unit: worldscale_pct
  values:
  - 50.0
- section: Main
  section_type: null
  source_line: The swing in volumes is unprecedented. Between September and November
    the change in the gap been Pacific and Atlantic Basin amounted to 1.3mbd and in
    the four months to January even to 1.5mbd. For jet/kero the last three months
    mark the only time outside the c
  unit: null
  values:
  - 1.3
  - 1.5
- section: Main
  section_type: null
  source_line: 'Looking forward, the No1 uncertainty factor in 2025 oil markets is
    the imposition of trade tariffs by the Trump administration (and possible retaliation).
    For instance, if the US were to tax Canadian and Mexican energy imports, all TMX
    crude would be rerouted '
  unit: null
  values:
  - 2025.0
- section: Main
  section_type: null
  source_line: 'For now, the biggest challenge to the oil market, however, is coming
    from late actions of the Biden administration. The sanctions on 155 oil tankers
    by OFAC on January 10 have not yet reduced the exports of Russian crude oil, but
    clear question marks arise on '
  unit: null
  values:
  - 155.0
  - 10.0
- section: Main
  section_type: null
  source_line: Our base case remains that ultimately - after a build-up of barrels
    at sea - ways will be found, especially in China, to take in (strongly) discounted
    sanctioned barrels from both Russia and Iran. But the chances of real supply losses
    are growing it seems. And
  unit: null
  values:
  - 1.5
  - 5.0
...
source_path: reports/breakwave/2025/2025-01-29_uncertainty-vs-volatility-and-the-difference-between-flows-a.html
source_stem: 2025-01-29_uncertainty-vs-volatility-and-the-difference-between-flows-a
source_url: https://www.breakwaveadvisors.com/insights/2025/1/29/uncertainty-vs-volatility-and-the-difference-between-flows-and-freight
summary: 'Main

  In this big picture take, we try to dissect uncertainty from volatility, looking
  at the diverging fields of supply/demand and with that overall trade levels, as
  opposed to tonne-mileage in the freight market. By David Wech

  The 2020s have been fraught with turbulences, including amid others the Covid-related
  demand shock, the steep recovery afterwards coinciding with the start of the Russia-Ukraine
  war, and the subsequent massive changes in global trade flows due to sanctions.
  Up to late 2022, these turbulences were also reflected in wide fluctuations of oil
  prices, stretching over a price band of more than $100/b, expanding a highly volatile
...
- meg
- europe
title: Uncertainty Vs Volatility And The Difference Between Flows And Freight
vessel_classes:
- capesize
- panamax
- supramax
...
## Summary
Main
In this big picture take, we try to dissect uncertainty from volatility, looking at the diverging fields of supply/demand and with that overall trade levels, as opposed to tonne-mileage in the freight market. By David Wech
The 2020s have been fraught with turbulences, including amid others the Covid-related demand shock, the steep recovery afterwards coinciding with the start of the Russia-Ukraine war, and the subsequent massive changes in global trade flows due to sanctions. Up to late 2022, these turbulences were also reflected in wide fluctuations of oil prices, stretching over a price band of more than $100/b, expanding a highly volatile period from 2004 onwards.
