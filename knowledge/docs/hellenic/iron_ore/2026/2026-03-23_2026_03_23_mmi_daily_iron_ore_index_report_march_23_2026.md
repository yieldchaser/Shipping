...
- crude_oil
date: '2026-03-23'
doc_id: hellenic_iron_ore_2026-03-23_2026_03_23_mmi_daily_iron_ore_index_report_march_23_2026
...
signals:
  ...
  - metric: numeric_observation
    source_line: in Chinese iron ore and steelmaking prices 23/03/2026
    unit: null
    values:
    - 23.0
    - 3.0
    - 2026.0
  - metric: numeric_observation
    source_line: Dalian iron ore futures exhibited a volatile but firm upward trend
      today, with the most-traded I2605 contractconcluding the session at 819 RMB
      per tonne, marking a 0.92% increase from the prior trading day. In the physical
      market, spot prices registered a mode
    unit: pct
    values:
    - 605.0
    - 819.0
    ...
    - 3.5
  - metric: index
    source_line: MMi Daily Iron Ore Index Report Mar 23rd, 2026
    unit: null
    values:
    - 23.0
    - 2026.0
  ...
  - metric: numeric_observation
    ...
    - 35.0
  - metric: numeric_observation
    source_line: Mar 23rd, 2026 FOT Qingdao (inc. 13% VAT), RMB/wet tonne CFR Qingdao
    ...
    - 13.0
  - metric: index_62_fines
    source_line: IOPI62 62% Fe Fines 801 4 0.5% 787 828 683 1063 107.86 0.59 0.6%
      102.62 108.09 89.33 140.24
    unit: pct
    values:
    - 2.0
    - 62.0
  ...
  - metric: index_58_fines
    source_line: IOPI58 58% Fe Fines 729 2 0.3% 694 727 610 963 98.89 0.33 0.3% 91.01
      95.59 80.25 128.13
    unit: pct
    values:
    - 8.0
    ...
    - 610.0
  - metric: index_65_fines
    source_line: IOPI65 65% Fe Fines 920 5 0.5% 897 938 794 1175 124.49 0.65 0.5%
      117.37 122.97 104.47 155.37
    unit: pct
    values:
    - 5.0
    - 65.0
    ...
    - 794.0
  - metric: numeric_observation
    source_line: Mar 23rd, 2026 CFR Qingdao, USD/dry tonne DalianÊironÊoreÊfuturesÊexhibitedÊaÊvola(cid:415)leÊbutÊfirmÊupwardÊtrendÊtoday,ÊwithÊtheÊmost-tradedÊI2605ÊcontractÊconcludingÊtheÊsessionÊatÊ819ÊRMBÊperÊtonne,ÊmarkingÊaÊ0.92%Ê
    unit: usd
    values:
    - 23.0
    - 2026.0
    ...
    - 0.92
  - metric: index
    source_line: Index Fe Content Price Change Change % MTD YTD Low 2 High 2 FromÊaÊfundamental'sÊperspec(cid:415)ve,ÊSMMÊdataÊindicatesÊthatÊglobalÊironÊoreÊshipmentsÊ
      lastÊweekÊtotalledÊ33.63ÊmillionÊtonnes,ÊaÊslightÊweek-on-weekÊincreaseÊofÊ5.2%,ÊwhileÊ
    unit: pct
    values:
    - 2.0
    - 2.0
    ...
    - 5.2
  - metric: index_62_fines
    source_line: IOSI62 62% Fe Fines 107.00 0.80 0.76% 103.52 109.05 89.79 142.65
      WhenÊfactoringÊinÊtheÊdeceleratedÊpaceÊofÊportÊstockÊaccumula(cid:415)onÊandÊincreasedÊportÊo(cid:335)ake,ÊtheÊpreviouslyÊoversuppliedÊstateÊofÊtheÊmarketÊhasÊshownÊshort-termÊimprovement.Ê
    unit: pct
    values:
    - 2.0
    - 62.0
    ...
    - 89.79
  - metric: index_65_fines
    source_line: IOSI65 65% Fe Fines 125.96 1.26 1.01% 115.74 123.69 98.23 171.65
      DespiteÊthis,ÊoverallÊbullishÊsen(cid:415)mentÊremainsÊstrong.ÊTherefore,ÊitÊisÊan(cid:415)cipatedÊthatÊironÊoreÊpricesÊwillÊcon(cid:415)nueÊtoÊfluctuateÊatÊanÊelevatedÊlevelÊthroughoutÊtheÊweek.
    unit: pct
    values:
    - 5.0
    - 65.0
  ...
  - metric: index_65_fines
    ...
    - 892.0
  - metric: numeric_observation
    source_line: Mar 23rd, 2026 CFR Qingdao, USD/dry tonne Mar 20th, 2026 FREIGHT
  ...
  - metric: index
    ...
    - 2.0
  - metric: index_62_fines
    source_line: IOSI62 62% Fe Fines 106.33 105.42 106.27 99.65 103.52 102.85 109.05
      W. Australia - Qingdao C5 11.77 -0.51 -4.1% 5.92 14.89
    unit: pct
    values:
    - 2.0
    - 62.0
    ...
    - 102.85
  - metric: index_65_fines
    source_line: IOSI65 65% Fe Fines 122.46 121.09 121.51 118.61 115.74 114.92 123.69
      Tubarao - Qingdao C3 30.53 0.07 0.2% 16.08 35.02
    unit: pct
    values:
    - 5.0
    - 65.0
  ...
  - metric: numeric_observation
    ...
    - 13.0
  - metric: index
    source_line: Mar 23rd, 2026 PORT STOCK INDEX (RMB/WT) Mar 23rd, 2026 SEABORNE
      INDEX (USD/DMT)
    unit: usd_per_dmt
    values:
    - 23.0
  ...
  - metric: index_62_fines
    ...
    - 2.0
  - metric: index_58_fines
    source_line: IOPI58 58% Fe Fines -72 -8.99%
    unit: pct
    values:
    - 8.0
    - 58.0
    ...
    - -8.99
  - metric: index_65_fines
    source_line: IOPI65 65% Fe Fines 119 14.88% IOSI65 65% Fe Fines 18.95 17.71%
    unit: pct
    values:
    - 5.0
    - 65.0
  ...
  - metric: index_62_fines
    ...
    - 5.0
  - metric: index_65_fines
    source_line: SIMEC Fines 789 5 -12 SIMEC Fines 96.00 0.65 -11.00
    unit: null
    values:
    - 789.0
    - 5.0
    ...
    - -11.0
  - metric: numeric_observation
    source_line: PB Fines 810 5 9 PB Fines 107.00 1.10 0.00
    unit: null
    values:
    - 810.0
    - 5.0
    ...
    - 0.0
  - metric: index_65_fines
    source_line: Newman Fines 807 5 6 Newman Fines 104.00 0.65 -3.00
    unit: null
    values:
    - 807.0
    - 5.0
    ...
    - -3.0
  - metric: numeric_observation
    source_line: MAC Fines 801 5 0 MAC Fines 103.80 1.45 -3.20
    unit: null
    values:
    - 801.0
    - 5.0
    ...
    - -3.2
  - metric: numeric_observation
    source_line: Jimblebar Blended Fines 719 5 -82 Jimblebar Blended Fines 96.60 1.40
      -10.40
    unit: null
    values:
    - 719.0
    ...
    - -10.4
  - metric: numeric_observation
    source_line: Carajas Fines 893 5 92 Carajas Fines 126.10 0.90 19.10
    unit: null
    values:
    - 893.0
    - 5.0
    ...
    - 19.1
  - metric: numeric_observation
    source_line: Brazilian Blend Fines 867 5 66 Brazilian Blend Fines 114.30 1.25
      7.30
    unit: null
    values:
    - 867.0
    ...
    - 7.3
  - metric: numeric_observation
    source_line: RTX Fines 678 5 -123 RTX Fines 96.80 0.80 -10.20
    unit: null
    values:
    - 678.0
    - 5.0
    ...
    - -10.2
  - metric: numeric_observation
    source_line: West Pilbara Fines 800 5 -1 West Pilbara Fines 98.70 0.50 -8.30
    unit: null
    values:
    - 800.0
    - 5.0
    ...
    - -8.3
  - metric: numeric_observation
    source_line: FMG Blended Fines 741 3 12
    unit: null
    values:
    - 741.0
    - 3.0
    - 12.0
  - metric: numeric_observation
    source_line: Western Fines 697 3 -32
    unit: null
    values:
    - 697.0
    - 3.0
    - -32.0
  - metric: numeric_observation
    source_line: Atlas Fines 743 3 14
    unit: null
    values:
    - 743.0
    - 3.0
...
source: hellenic
source_path: reports/hellenic/iron_ore/2026/2026-03-23_mmi-daily-iron-ore-index-report-march-23-2026.html
source_stem: 2026-03-23_mmi-daily-iron-ore-index-report-march-23-2026
source_url: https://www.hellenicshippingnews.com/mmi-daily-iron-ore-index-report-march-23-2026
summary: 'Main

  in Chinese iron ore and steelmaking prices 23/03/2026

  Dalian iron ore futures exhibited a volatile but firm upward trend today, with the
  most-traded I2605 contractconcluding the session at 819 RMB per tonne, marking a
  0.92% increase from the prior trading day. In the physical market, spot prices registered
  a modest gain of approximately 1-2 RMB. Trading houses were reasonably active in
  offering quotes, whereas steel mills maintained a cautious approach to procurement,
  resulting in subdued transaction volumes.'
themes:
- china
- brazil
- australia
...
- iron_ore
- bauxite
title: MMI Daily Iron Ore Index Report March 23 2026
vessel_classes:
- capesize
- panamax
---
...
Main
in Chinese iron ore and steelmaking prices 23/03/2026
Dalian iron ore futures exhibited a volatile but firm upward trend today, with the most-traded I2605 contractconcluding the session at 819 RMB per tonne, marking a 0.92% increase from the prior trading day. In the physical market, spot prices registered a modest gain of approximately 1-2 RMB. Trading houses were reasonably active in offering quotes, whereas steel mills maintained a cautious approach to procurement, resulting in subdued transaction volumes.

## Main
in Chinese iron ore and steelmaking prices 23/03/2026
Dalian iron ore futures exhibited a volatile but firm upward trend today, with the most-traded I2605 contractconcluding the session at 819 RMB per tonne, marking a 0.92% increase from the prior trading day. In the physical market, spot prices registered a modest gain of approximately 1-2 RMB. Trading houses were reasonably active in offering quotes, whereas steel mills maintained a cautious approach to procurement, resulting in subdued transaction volumes. From a fundamental's perspective, SMM data indicates that global iron ore shipments last week totalled 33.63 million tonnes, a slight week-on-week increase of 5.2%, while arrivals at Chinese ports contracted by 3.5% to 27.14 million tonnes. When factoring in the decelerated pace of port stock accumulation and increased port offtake, the previously oversupplied state of the market has shown short-term improvement. Concurrently, demand is recovering as blast furnaces progressively resume operations, causing market fundamentals to become increasingly bullish. On the market intelligence front, the prevailing trend remains uncertain due to a stalemate in long-term contract negotiations, which has prompted most investment capital to adopt a wait-and-see stance. Despite this, overall bullish sentiment remains strong. Therefore, it is anticipated that iron ore prices will continue to fluctuate at an elevated level throughout the week.
Image reference: 2026-03-23_mmi-daily-iron-ore-index-report-march-23-2026_img2.jpg
Source: Metals Market Index (MMI)

## Linked asset: 2026-03-23_20260323181327.pdf
Source asset: reports/hellenic/iron_ore/pdfs/2026-03-23_20260323181327.pdf

[Page 1]
MMi Daily Iron Ore Index Report Mar 23rd, 2026
MMi Dashboard
...
801 920 729
4 0.53% 4.69 0.51% 2 0.33%
Mar 23rd, 2026 Mar 23rd, 2026 Mar 23rd, 2026
...
107.00 125.96 900
0.80 0.76% 1.26 1.01% -10 -1.10%
Mar 23rd, 2026 Mar 23rd, 2026 Week Ending Mar 20th, 2026
...
819.00 108.20 3154
3.50 0.43% -0.05 -0.05% 31 0.99%
Mar 23rd, 2026 (3pm close) Mar 23rd, 2026 (5.30 pm Print) Mar 23rd, 2026 (3pm close)
Freight Rates Steel Price
C3, Tubarao - Qingdao USD/t C5, W. Australia - Qingdao USD/t Steel Rebar (China Domestic) RMB/t
30.53 11.77 3154
0.07 0.2% -0.51 -4.1% -10 -0.32%
...
Page 1/6 Mar 23rd, 2026

[Page 2]
MMi Daily Iron Ore Index Report Mar 23rd, 2026
IRON ORE PORT STOCK INDEX (IOPI)
Mar 23rd, 2026 FOT Qingdao (inc. 13% VAT), RMB/wet tonne CFR Qingdao Equivalent (exc. 13% VAT), USD/dry tonne ¹
Index Fe Content Price Change Change % MTD YTD Low ² High ² Price Change Change % MTD YTD Low ² High ²
IOPI62 62% Fe Fines 801 4 0.5% 787 828 683 1063 107.86 0.59 0.6% 102.62 108.09 89.33 140.24
IOPI58 58% Fe Fines 729 2 0.3% 694 727 610 963 98.89 0.33 0.3% 91.01 95.59 80.25 128.13
IOPI65 65% Fe Fines 920 5 0.5% 897 938 794 1175 124.49 0.65 0.5% 117.37 122.97 104.47 155.37
IRON ORE SEABORNE INDEX (IOSI) MARKET COMMENTARY
Mar 23rd, 2026 CFR Qingdao, USD/dry tonne DalianÊironÊoreÊfuturesÊexhibitedÊaÊvola(cid:415)leÊbutÊfirmÊupwardÊtrendÊtoday,ÊwithÊtheÊmost-tradedÊI2605ÊcontractÊconcludingÊtheÊsessionÊatÊ819ÊRMBÊperÊtonne,ÊmarkingÊaÊ0.92%Ê
increaseÊfromÊtheÊpriorÊtradingÊday.ÊInÊtheÊphysicalÊmarket,ÊspotÊpricesÊregisteredÊaÊmodestÊgainÊofÊapproximatelyÊ1-2ÊRMB.ÊTradingÊhousesÊwereÊreasonablyÊac(cid:415)veÊinÊofferingÊ
quotes,ÊwhereasÊsteelÊmillsÊmaintainedÊaÊcau(cid:415)ousÊapproachÊtoÊprocurement,Êresul(cid:415)ngÊinÊsubduedÊtransac(cid:415)onÊvolumes.Ê
Index Fe Content Price Change Change % MTD YTD Low 2 High 2
Brazilian SSF 874 5 73 Brazilian SSF 103.10 0.90 -3.90
Brazilian Blend Fines 867 5 66 Brazilian Blend Fines 114.30 1.25 7.30
RTX Fines 678 5 -123 RTX Fines 96.80 0.80 -10.20
West Pilbara Fines 800 5 -1 West Pilbara Fines 98.70 0.50 -8.30
Mar 23rd, 2026 PORT STOCK INDEX (RMB/WT)
Price Change Diff to IOPI58
SSF 680 3 -49
FMG Blended Fines 741 3 12
Robe River 738 3 9
Western Fines 697 3 -32
Atlas Fines 743 3 14
Yandi 719 3 -10
...
Low Fe Grade Al 2.25-4% 9.00 0.00
High Fe Grade Si <4% 11.00 0.00 High Fe Grade Si <4% 2.25 0.00
1% Silica High Fe Grade Si 4-6.5% 20.00 0.00 1% Silica High Fe Grade Si 4 - 6.5% 6.50 0.00
Low Fe Grade 19.00 0.00
High Fe Grade 0.09%<P<0.115% 25.00 0.00 0.01% High Fe Grade 0.09%<P<0.115% 1.75 0.00
0.01%
...
Qingdao 32.30 0.34% 22.28 34.83 Closing Price 819.00 3.50 0.43% 108.20 -0.05 -0.05%
Caofeidian 17.68 0.91% 7.56 20.28 Vol traded ('000 lots) 26.33 1.60 6.49% 9.30 2.21 31.08%
Tianjin 12.25 -2.16% 6.64 12.52 Open positions ('000 lots) 44.19 -0.83 -1.83% 48.39 -1.15 -2.33%
Rizhao 12.71 2.33% 11.52 21.35 Day Low 812.5 12.50 1.56% 107.45 1.25 1.18%
Total (35 Ports) 156.39 0.63% 105.01 166.39 Day High 826.0 7.50 0.92% 108.65 0.20 0.18%
60.00 130
50.00 120
40.00
110
...
Mar 23rd, 2026 Specifications applied for 62% brand assessments Specifications applied for 62% brand assessments
...
Mar 23rd, 2026 Specifications applied for 58% brand assessments
...
Page 6/6 Mar 23rd, 2026
COPYRIGHTÊMETALSÊMARKETÊINDEX,ÊALLÊRIGHTSÊRESERVED

## Linked asset: 2026-03-23_mmi-daily-iron-ore-index-report-march-23-2026_img2.jpg
Source asset: reports/hellenic/iron_ore/2026/2026-03-23_mmi-daily-iron-ore-index-report-march-23-2026_img2.jpg

Linked image asset: 2026-03-23_mmi-daily-iron-ore-index-report-march-23-2026_img2.jpg
...
Mar 23rd, 2026 FOT Qingdao (inc. 13% VAT), RMB/wet tonne CFR Qingdao Equivalent (exc. 13% VAT), USD/dry tonne '
Index Fe Content Price Change Change% MTD YTD Low ? High # Price Change Change% MTD YTD Low ?# High?
1OPI62. 62%FeFines 801 4 0.5% 787 828 683 1063 107.86 0.59 0.6% 102.62 108.09 89.33 140.24
1OPIS8 58%FeFines 729 2 0.3% 694 727 610 963 98.89 0.33 0.3% 91.01 95.59 80.25 128.13
1OPI6S 65%FeFines 920 5 0.5% 897 938 794 1175 124.49 0.65 0.5% 117.37. 122.97 104.47 155.37
IRON ORE SEABORNE INDEX (IOS!) MARKET COMMENTARY
Mar 23rd, 2026 CFR Qingdao, USD/dry tonne ieniels taba inceser eathigsdoy snesegtqpteasonad agua pantaguonsa masnagtaleggesasanty Lato, Roane asleneeseieaan lenatoeaeee
Index FeContent Price Change Change% MTD YTD Low * High * ean ee
10S162 62% FeFines 107.00 0.80 0.76% 103.52 109.05 89.79 142.65: || "coseceesee aeccadtscmorenegus tian taanant pupeemenpveseeranenaeen easteg cota eemoonean obezeoabeoaamagetdek Co eames eompeees"
10Si65 65% FeFines| 125.96 1.26 1.01% 115.74 123.69 98.23 171.65 |] eens seeenemein tna eaten ts engender nm Rao ed ng ee
IRON ORE PORT LUMP INDEX (IOPLI)
Week Ending Mar 20th, 2026 FOT Qingdao (inc. 13% VAT), RMB/wet tonne CFR Qingdao Equivalent (exc. 13% VAT), USD/dry tonne *
