...
- crude_oil
date: '2026-03-25'
doc_id: hellenic_iron_ore_2026-03-25_2026_03_25_mmi_daily_iron_ore_index_report_march_25_2026
...
signals:
  ...
  - metric: numeric_observation
    source_line: in Chinese iron ore and steelmaking prices 25/03/2026
    unit: null
    values:
    - 25.0
    - 3.0
    - 2026.0
  - metric: numeric_observation
    source_line: Dalian iron ore futures trended weaker throughout the day. The most-traded
      I2605 contract concluded the sessionat 806.5 RMB per tonne, a decrease of 1.83%
      from the previous trading day. In the physical market, spot prices fell by approximately
      5-10 RMB. Tradin
    unit: pct
    values:
    - 605.0
    ...
    - 15000.0
  - metric: numeric_observation
    source_line: 'Linked asset: 2026-03-25_MMi-Daily-Iron-Ore-Report-for-25th-March-2026.pdf'
    unit: null
    values:
    - 2026.0
    - -3.0
    ...
    - 2026.0
  - metric: index
    source_line: MMi Daily Iron Ore Index Report Mar 25th, 2026
    unit: null
    values:
    - 25.0
    - 2026.0
  ...
  - metric: numeric_observation
    ...
    - 35.0
  - metric: numeric_observation
    source_line: Mar 25th, 2026 FOT Qingdao (inc. 13% VAT), RMB/wet tonne CFR Qingdao
    ...
    - 13.0
  - metric: index_62_fines
    source_line: IOPI62 62% Fe Fines 791 -14 -1.8% 787 827 683 1063 106.41 -1.83 -1.7%
      102.64 108.08 89.33 140.24
    unit: pct
    values:
    - 2.0
    - 62.0
  ...
  - metric: index_58_fines
    source_line: IOPI58 58% Fe Fines 724 -7 -1.0% 694 727 610 963 98.23 -0.88 -0.9%
      91.05 95.60 80.25 128.13
    unit: pct
    values:
    - 8.0
    - 58.0
    ...
    - 610.0
  - metric: index_65_fines
    source_line: IOPI65 65% Fe Fines 924 0 0.0% 897 938 794 1175 124.94 0.18 0.1%
      117.41 122.97 104.47 155.37
    unit: pct
    values:
    - 5.0
    - 65.0
    ...
    - 794.0
  - metric: numeric_observation
    source_line: Mar 25th, 2026 CFR Qingdao, USD/dry tonne Dalian iron ore futures
      trended weaker throughout the day. The most-traded I2605 contract concluded
      the session at 806.5 RMB per tonne, a decrease of 1.83% from
    unit: usd
    values:
    - 25.0
    - 2026.0
    ...
    - 1.83
  - metric: index
    source_line: 'Index Fe Content Price Change Change % MTD YTD Low 2 High 2 A i
      c n c d o i r c d a i (cid:415) n n g g t o th t a h t e t h la e t e d s e
      t m SM an M d s s i u d r e v e re y m d a at in a s , a st v a e b ra le g
      e w d it a h i l a y s h li o g t h m t u e '
    unit: pct
    values:
    - 2.0
    - 2.0
    ...
    - 9.0
  - metric: index_62_fines
    source_line: IOSI62 62% Fe Fines 105.89 -0.98 -0.91% 103.53 109.04 89.79 142.65
      e e n x e e r r g t y e d p r s i o ce m s e , h p e r i e g s h s t u e r n
      e i n o g n g p lo ri b ce a s l . i n F fl ro a m (cid:415)o a n a m ry a c
      p r r o e e s c s o u n re o s m . T ic
    unit: pct
    values:
    - 2.0
    - 62.0
    ...
    - 89.79
  - metric: numeric_observation
    source_line: bulk commodi(cid:415)es, including iron ore. In summary, although
      iron ore prices face considerable resistance in the short term, the downside
      poten(cid:415)al is limited, and the
    unit: null
    values:
    - 415.0
    - 415.0
  - metric: index_65_fines
    source_line: IOSI65 65% Fe Fines 124.88 -0.91 -0.72% 115.79 123.69 98.23 171.65
      market is expected to con(cid:415)nue its range-bound consolida(cid:415)on.
    unit: pct
    values:
    - 5.0
    - 65.0
  ...
  - metric: index_65_fines
    ...
    - 892.0
  - metric: numeric_observation
    source_line: Mar 25th, 2026 CFR Qingdao, USD/dry tonne Mar 24th, 2026 FREIGHT
  ...
  - metric: index
    ...
    - 2.0
  - metric: index_62_fines
    source_line: IOSI62 62% Fe Fines 106.33 105.42 106.27 99.65 103.53 102.86 109.04
      W. Australia - Qingdao C5 11.49 -0.06 -0.5% 5.92 14.89
    unit: pct
    values:
    - 2.0
    - 62.0
    ...
    - 102.86
  - metric: index_65_fines
    source_line: IOSI65 65% Fe Fines 122.46 121.09 121.51 118.61 115.79 114.97 123.69
      Tubarao - Qingdao C3 30.28 -0.09 -0.3% 16.08 35.02
    unit: pct
    values:
    - 5.0
    - 65.0
  ...
  - metric: numeric_observation
    ...
    - 13.0
  - metric: index
    source_line: Mar 25th, 2026 PORT STOCK INDEX (RMB/WT) Mar 25th, 2026 SEABORNE
      INDEX (USD/DMT)
    unit: usd_per_dmt
    values:
    - 25.0
  ...
  - metric: index_62_fines
    ...
    - 2.0
  - metric: index_58_fines
    source_line: IOPI58 58% Fe Fines -66 -8.39%
    unit: pct
    values:
    - 8.0
    - 58.0
    ...
    - -8.39
  - metric: index_65_fines
    source_line: IOPI65 65% Fe Fines 133 16.80% IOSI65 65% Fe Fines 18.99 17.93%
    unit: pct
    values:
    - 5.0
    - 65.0
  ...
  - metric: index_62_fines
    ...
    - 5.0
  - metric: numeric_observation
    source_line: SIMEC Fines 779 -14 -12 SIMEC Fines 95.00 -0.70 -10.89
    unit: null
    values:
    - 779.0
    - -14.0
    ...
    - -10.89
  - metric: index_65_fines
    source_line: PB Fines 800 -14 9 PB Fines 105.90 -0.65 0.01
    unit: null
    values:
    - 800.0
    - -14.0
    ...
    - 0.01
  - metric: numeric_observation
    source_line: Newman Fines 797 -14 6 Newman Fines 102.90 -0.60 -2.99
    unit: null
    values:
    - 797.0
    - -14.0
    ...
    - -2.99
  - metric: numeric_observation
    source_line: MAC Fines 791 -14 0 MAC Fines 102.70 -0.60 -3.19
    unit: null
    values:
    - 791.0
    - -14.0
    ...
    - -3.19
  - metric: numeric_observation
    source_line: Jimblebar Blended Fines 710 -13 -81 Jimblebar Blended Fines 95.50
      -0.40 -10.39
    unit: null
    values:
    - 710.0
    ...
    - -10.39
  - metric: numeric_observation
    source_line: Carajas Fines 884 -13 93 Carajas Fines 124.70 -0.70 18.81
    unit: null
    values:
    - 884.0
    - -13.0
    ...
    - 18.81
  - metric: numeric_observation
    source_line: Brazilian Blend Fines 857 -14 66 Brazilian Blend Fines 112.90 -0.80
      7.01
    unit: null
    values:
    - 857.0
    ...
    - 7.01
  - metric: numeric_observation
    source_line: RTX Fines 668 -13 -123 RTX Fines 95.10 -1.05 -10.79
    unit: null
    values:
    - 668.0
    - -13.0
    ...
    - -10.79
  - metric: numeric_observation
    source_line: West Pilbara Fines 790 -14 -1 West Pilbara Fines 97.40 -0.90 -8.49
    unit: null
    values:
    - 790.0
    - -14.0
    ...
    - -8.49
  - metric: numeric_observation
    source_line: FMG Blended Fines 736 -7 12
    unit: null
    values:
    - 736.0
    - -7.0
    - 12.0
  - metric: numeric_observation
    source_line: Western Fines 692 -8 -32
    unit: null
    values:
    - 692.0
    - -8.0
    - -32.0
  - metric: numeric_observation
    source_line: Atlas Fines 738 -7 14
    unit: null
    values:
    - 738.0
    - -7.0
...
source: hellenic
source_path: reports/hellenic/iron_ore/2026/2026-03-25_mmi-daily-iron-ore-index-report-march-25-2026.html
source_stem: 2026-03-25_mmi-daily-iron-ore-index-report-march-25-2026
source_url: https://www.hellenicshippingnews.com/mmi-daily-iron-ore-index-report-march-25-2026
summary: 'Main

  in Chinese iron ore and steelmaking prices 25/03/2026

  Dalian iron ore futures trended weaker throughout the day. The most-traded I2605
  contract concluded the sessionat 806.5 RMB per tonne, a decrease of 1.83% from the
  previous trading day. In the physical market, spot prices fell by approximately
  5-10 RMB.'
themes:
- china
- brazil
...
- iron_ore
- bauxite
title: MMI Daily Iron Ore Index Report March 25 2026
vessel_classes:
- capesize
- panamax
---
...
Main
in Chinese iron ore and steelmaking prices 25/03/2026
Dalian iron ore futures trended weaker throughout the day. The most-traded I2605 contract concluded the sessionat 806.5 RMB per tonne, a decrease of 1.83% from the previous trading day. In the physical market, spot prices fell by approximately 5-10 RMB.

## Main
in Chinese iron ore and steelmaking prices 25/03/2026
redirected to the domes(cid:415)c market, including certain grades suitable for Direct Reduced Iron (DRI) produc(cid:415)on. This has increased the variety of supply available and
IOSI62 62% Fe Fines 105.89 -0.98 -0.91% 103.53 109.04 89.79 142.65 e e n x e e r r g t y e d p r s i o ce m s e , h p e r i e g s h s t u e r n e i n o g n g p lo ri b ce a s l . i n F fl ro a m (cid:415)o a n a m ry a c p r r o e e s c s o u n re o s m . T ic h p is e h rs a p s e s c ig (cid:415) n v i e fi , c s a u n s t t l a y i n w e e d a k te e n n s e i d o n e s x p in e t c h ta e (cid:415) M on id s d f l o e r E U a S s t d a o n ll d a r a i n n t e e s r c e a s la t (cid:415) ra o t n e o c f u t c s o , n le fl a ic d t i n h g a v t e o t a r i p g r g i e ce re c d o a rr s e h c a (cid:415) r o p n r a is c e r o in ss
bulk commodi(cid:415)es, including iron ore. In summary, although iron ore prices face considerable resistance in the short term, the downside poten(cid:415)al is limited, and the
IOSI65 65% Fe Fines 124.88 -0.91 -0.72% 115.79 123.69 98.23 171.65 market is expected to con(cid:415)nue its range-bound consolida(cid:415)on.
...
IOPI62 62% Fe Fines 805 798 810 769 787 783 827 105.46 100.24 107.43 102.60 102.64 102.02 108.08
IOPI58 58% Fe Fines 720 716 719 699 694 689 727 95.02 94.72 96.04 93.94 91.05 90.38 95.60
IOPI65 65% Fe Fines 917 925 900 852 897 892 938 120.64 122.17 119.85 114.11 117.41 116.83 122.97
IRON ORE SEABORNE INDEX MONTHLY, QUARTERLY AND YEAR-TO-DATE AVERAGES FREIGHT RATES
Mar 25th, 2026 CFR Qingdao, USD/dry tonne Mar 24th, 2026 FREIGHT RATES - DRY BULK US$/wet tonne
Index Fe Content NovemberDecember January February MTD QTD YTD Route Designation Change Change % Low 2 High 2
IOSI62 62% Fe Fines 106.33 105.42 106.27 99.65 103.53 102.86 109.04 W. Australia - Qingdao C5 11.49 -0.06 -0.5% 5.92 14.89
IOSI65 65% Fe Fines 122.46 121.09 121.51 118.61 115.79 114.97 123.69 Tubarao - Qingdao C3 30.28 -0.09 -0.3% 16.08 35.02
...
Mar 25th, 2026 PORT STOCK INDEX (RMB/WT) Mar 25th, 2026 SEABORNE INDEX (USD/DMT)
Index Fe Content Spread to IOPI62 % Spread to IOPI62 Index Fe Content Spread to IOSI62 % Spread to IOSI62
IOPI58 58% Fe Fines -66 -8.39%
IOPI65 65% Fe Fines 133 16.80% IOSI65 65% Fe Fines 18.99 17.93%
Page 2/6 Mar 25th, 2026
...
Roy Hill 752 -14 -39 Roy Hill 99.20 -0.50 -6.69
SIMEC Fines 779 -14 -12 SIMEC Fines 95.00 -0.70 -10.89
PB Fines 800 -14 9 PB Fines 105.90 -0.65 0.01
Newman Fines 797 -14 6 Newman Fines 102.90 -0.60 -2.99
MAC Fines 791 -14 0 MAC Fines 102.70 -0.60 -3.19
Jimblebar Blended Fines 710 -13 -81 Jimblebar Blended Fines 95.50 -0.40 -10.39
Carajas Fines 884 -13 93 Carajas Fines 124.70 -0.70 18.81
Brazilian SSF 865 -14 74 Brazilian SSF 102.00 -0.70 -3.89
Brazilian Blend Fines 857 -14 66 Brazilian Blend Fines 112.90 -0.80 7.01
RTX Fines 668 -13 -123 RTX Fines 95.10 -1.05 -10.79
West Pilbara Fines 790 -14 -1 West Pilbara Fines 97.40 -0.90 -8.49
Mar 25th, 2026 PORT STOCK INDEX (RMB/WT)
Price Change Diff to IOPI58
SSF 676 -7 -48
FMG Blended Fines 736 -7 12
Robe River 733 -7 9
Western Fines 692 -8 -32
Atlas Fines 738 -7 14
Yandi 714 -7 -10
...
High Grade Fe 60 - 63% 10.00 5.00 High Grade Fe 60 - 63% 5.25 0.25
...
High Fe Grade Si <4% 22.00 5.00 High Fe Grade Si <4% 2.25 0.00
1% Silica High Fe Grade Si 4-6.5% 20.00 0.00 1% Silica High Fe Grade Si 4 - 6.5% 6.50 0.00
Low Fe Grade 11.00 -4.00
High Fe Grade 0.09%<P<0.115% 15.00 -5.00 0.01% High Fe Grade 0.09%<P<0.115% 1.75 0.00
0.01%
High Fe Grade 0.115%<P<0.15% 15.00 -5.00 Phosphorus High Fe Grade 0.115%<P<0.15% 1.75 0.00
Phosphorus
...
Qingdao 32.30 0.34% 22.28 34.83 Closing Price 806.50 -17.50 -2.12% 105.10 -2.60 -2.41%
Caofeidian 17.68 0.91% 7.56 20.28 Vol traded ('000 lots) 37.86 15.89 72.28% 17.39 9.93 133.21%
Tianjin 12.25 -2.16% 6.64 12.52 Open positions ('000 lots) 41.43 -3.16 -7.08% 47.76 -0.51 -1.05%
Rizhao 12.71 2.33% 11.52 21.35 Day Low 801.0 -12.00 -1.48% 105.00 -2.15 -2.01%
Total (35 Ports) 156.39 0.63% 105.01 166.39 Day High 831.0 1.50 0.18% 108.40 -0.50 -0.46%
60.00 130
50.00 120
40.00
110
...
Mar 25th, 2026 Specifications applied for 62% brand assessments Specifications applied for 62% brand assessments
...
Mar 25th, 2026 Specifications applied for 58% brand assessments
...
Page 6/6 Mar 25th, 2026
COPYRIGHT METALS MARKET INDEX, ALL RIGHTS RESERVED

## Linked asset: 2026-03-25_mmi-daily-iron-ore-index-report-march-25-2026_img2.jpg
Source asset: reports/hellenic/iron_ore/2026/2026-03-25_mmi-daily-iron-ore-index-report-march-25-2026_img2.jpg

Linked image asset: 2026-03-25_mmi-daily-iron-ore-index-report-march-25-2026_img2.jpg
...
Mar 25th, 2026 FOT Qingdao (inc. 13% VAT), RMB/wet tonne CFR Qingdao Equivalent (exc. 13% VAT), USD/dry tonne '
Index Fe Content Price Change Change% MTD YTD Low? High ? Price Change Change% MTD YTD Low ? High ?
1OPIG2 62%FeFines| 791 -14 -1.8% 787 827 683 1063 | 106.41 = -1.83 1.7% 102.64 108.08 89.33 140.24
1OPIS8 58%FeFines| 724 7 -1.0% 694 727 610 963 98.23 -0.88 0.9% 91.05 9560 80.25 128.13
1OPI6S 65%FeFines) 924 i) 0.0% 897 938 794 1175 | 124.94 0.18 0.1% 117.41 122.97 104.47 155.37
IRON ORE SEABORNE INDEX (IOS!) MARKET COMMENTARY
Mar 25th,2026 CFR Qingdao, USD/dry tonne Kream eorparerenon nag manatee eens wa ot eaten ane
Index FeContent | Price | Change Change% MTD YTD Low? - High? | "Wccsstyeutnesommnsnarremam sancvan sg spunbond Ont pp se we rn r rg orgaty deseo be ae atone sen
10S162 62% FeFines| 105.89 -0.98 -0.91% 103.53 109.04 89.79 142.65. || cmmreamreqnenng gosintanonry pores Tabonngstcnty weer pectoris nsg pee ms
10SI65 65% FeFines| 124.88 -0.91 -0.72% 115.79 123.69 98.23 171.65 a aa ia aaa
IRON ORE PORT LUMP INDEX (IOPLI)
FOT Qingdao (inc. 13% VAT), RMB/wet tonne CFR Qingdao Equivalent (exc. 13% VAT), USD/dry tonne *
Index Fe Content | Price W-o-W Change% MTD YTD Low 7 High * Price W-owW Change% MTD YTD Low 7 High 7
IOPLIG2 | 625%Felump | 900 -10 -1.1% 895 952 820 1210 | 116.57 -1.26 -1.07% 112.25 119.67 102.77 153.57
