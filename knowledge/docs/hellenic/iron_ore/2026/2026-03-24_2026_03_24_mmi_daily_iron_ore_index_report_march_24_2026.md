...
- crude_oil
date: '2026-03-24'
doc_id: hellenic_iron_ore_2026-03-24_2026_03_24_mmi_daily_iron_ore_index_report_march_24_2026
...
signals:
  ...
  - metric: numeric_observation
    source_line: in Chinese iron ore and steelmaking prices 24/03/2026
    unit: null
    values:
    - 24.0
    - 3.0
    - 2026.0
  - metric: numeric_observation
    source_line: Dalian iron ore futures strengthened during the morning session before
      paring gains in the afternoon.The most-traded I2605 contract setiled at 824
      RMB per tonne, representing a 0.55% increase from the prior trading day. In
      the physical market, spot prices incr
    unit: pct
    values:
    - 605.0
    - 824.0
    ...
    - 180000.0
  - metric: numeric_observation
    source_line: 'Linked asset: 2026-03-24_MMi-Daily-Iron-Ore-Report-for-24th-March-2026.pdf'
    unit: null
    values:
    - 2026.0
    - -3.0
    ...
    - 2026.0
  - metric: index
    source_line: MMi Daily Iron Ore Index Report Mar 24th, 2026
    unit: null
    values:
    - 24.0
    - 2026.0
  ...
  - metric: numeric_observation
    ...
    - 35.0
  - metric: numeric_observation
    source_line: Mar 24th, 2026 FOT Qingdao (inc. 13% VAT), RMB/wet tonne CFR Qingdao
    ...
    - 13.0
  - metric: index_62_fines
    source_line: IOPI62 62% Fe Fines 805 4 0.5% 787 828 683 1063 108.24 0.38 0.4%
      102.63 108.09 89.33 140.24
    unit: pct
    values:
    - 2.0
    - 62.0
  ...
  - metric: index_58_fines
    source_line: IOPI58 58% Fe Fines 732 3 0.4% 694 727 610 963 99.11 0.22 0.2% 91.03
      95.59 80.25 128.13
    unit: pct
    values:
    - 8.0
    ...
    - 610.0
  - metric: index_65_fines
    source_line: IOPI65 65% Fe Fines 924 4 0.4% 897 938 794 1175 124.76 0.27 0.2%
      117.39 122.97 104.47 155.37
    unit: pct
    values:
    - 5.0
    - 65.0
    ...
    - 794.0
  - metric: numeric_observation
    source_line: Mar 24th, 2026 CFR Qingdao, USD/dry tonne Dalian iron ore futures
      strengthened during the morning session before paring gains in the a(cid:332)ernoon.
      The most-traded I2605 contract se(cid:425)led at 824
    unit: usd
    values:
    - 24.0
    - 2026.0
    ...
    - 824.0
  - metric: index
    source_line: Index Fe Content Price Change Change % MTD YTD Low 2 High 2 remained
      cau(cid:415)ous, resul(cid:415)ng in moderate transac(cid:415)on volumes. On
      a fundamental basis, the intensity of blast furnace maintenance has con(cid:415)nued
      to
    unit: pct
    values:
    - 2.0
    ...
    - 415.0
  - metric: index_62_fines
    source_line: IOSI62 62% Fe Fines 106.87 -0.13 -0.12% 103.52 109.05 89.79 142.65
      the demand side. Concurrently, (cid:415)ght supply condi(cid:415)ons persist
      with no significant news of adjustments, which con(cid:415)nues to exert a bullish
      influence on
    unit: pct
    values:
    - 2.0
    ...
    - 89.79
  - metric: index_65_fines
    source_line: IOSI65 65% Fe Fines 125.79 -0.17 -0.13% 115.77 123.69 98.23 171.65
      sen(cid:415)ment. In summary, it is an(cid:415)cipated that iron ore prices
      will maintain a high-level consolida(cid:415)on pa(cid:425)ern in the near term.
    unit: pct
    values:
    - 5.0
    - 65.0
  ...
  - metric: index_65_fines
    ...
    - 892.0
  - metric: numeric_observation
    source_line: Mar 24th, 2026 CFR Qingdao, USD/dry tonne Mar 23rd, 2026 FREIGHT
  ...
  - metric: index
    ...
    - 2.0
  - metric: index_62_fines
    source_line: IOSI62 62% Fe Fines 106.33 105.42 106.27 99.65 103.52 102.86 109.05
      W. Australia - Qingdao C5 11.55 -0.22 -1.9% 5.92 14.89
    unit: pct
    values:
    - 2.0
    - 62.0
    ...
    - 102.86
  - metric: index_65_fines
    source_line: IOSI65 65% Fe Fines 122.46 121.09 121.51 118.61 115.77 114.95 123.69
      Tubarao - Qingdao C3 30.37 -0.16 -0.5% 16.08 35.02
    unit: pct
    values:
    - 5.0
    - 65.0
  ...
  - metric: numeric_observation
    ...
    - 13.0
  - metric: index
    source_line: Mar 24th, 2026 PORT STOCK INDEX (RMB/WT) Mar 24th, 2026 SEABORNE
      INDEX (USD/DMT)
    unit: usd_per_dmt
    values:
    - 24.0
  ...
  - metric: index_62_fines
    ...
    - 2.0
  - metric: index_58_fines
    source_line: IOPI58 58% Fe Fines -73 -9.10%
    unit: pct
    values:
    - 8.0
    - 58.0
    ...
    - -9.1
  - metric: index_65_fines
    source_line: IOPI65 65% Fe Fines 119 14.73% IOSI65 65% Fe Fines 18.92 17.70%
    unit: pct
    values:
    - 5.0
    - 65.0
  ...
  - metric: index_62_fines
    ...
    - 5.0
  - metric: numeric_observation
    source_line: SIMEC Fines 793 4 -12 SIMEC Fines 95.70 -0.30 -11.17
    unit: null
    values:
    - 793.0
    - 4.0
    ...
    - -11.17
  - metric: numeric_observation
    source_line: PB Fines 814 4 9 PB Fines 106.55 -0.45 -0.32
    unit: null
    values:
    - 814.0
    - 4.0
    ...
    - -0.32
  - metric: numeric_observation
    source_line: Newman Fines 811 4 6 Newman Fines 103.50 -0.50 -3.37
    unit: null
    values:
    - 811.0
    - 4.0
    ...
    - -3.37
  - metric: numeric_observation
    source_line: MAC Fines 805 4 0 MAC Fines 103.30 -0.50 -3.57
    unit: null
    values:
    - 805.0
    - 4.0
    ...
    - -3.57
  - metric: numeric_observation
    source_line: Jimblebar Blended Fines 723 4 -82 Jimblebar Blended Fines 95.90 -0.70
      -10.97
    unit: null
    values:
    - 723.0
    ...
    - -10.97
  - metric: numeric_observation
    source_line: Carajas Fines 897 4 92 Carajas Fines 125.40 -0.70 18.53
    unit: null
    values:
    - 897.0
    - 4.0
    ...
    - 18.53
  - metric: numeric_observation
    source_line: Brazilian Blend Fines 871 4 66 Brazilian Blend Fines 113.70 -0.60
      6.83
    unit: null
    values:
    - 871.0
    ...
    - 6.83
  - metric: index_65_fines
    source_line: RTX Fines 681 3 -124 RTX Fines 96.15 -0.65 -10.72
    unit: null
    values:
    - 681.0
    - 3.0
    ...
    - -10.72
  - metric: numeric_observation
    source_line: West Pilbara Fines 804 4 -1 West Pilbara Fines 98.30 -0.40 -8.57
    unit: null
    values:
    - 804.0
    - 4.0
    ...
    - -8.57
  - metric: numeric_observation
    source_line: FMG Blended Fines 743 2 11
    unit: null
    values:
    - 743.0
    - 2.0
    - 11.0
  - metric: numeric_observation
    source_line: Western Fines 700 3 -32
    unit: null
    values:
    - 700.0
    - 3.0
    - -32.0
  - metric: numeric_observation
    source_line: Atlas Fines 745 2 13
    unit: null
    values:
    - 745.0
    - 2.0
...
source: hellenic
source_path: reports/hellenic/iron_ore/2026/2026-03-24_mmi-daily-iron-ore-index-report-march-24-2026.html
source_stem: 2026-03-24_mmi-daily-iron-ore-index-report-march-24-2026
source_url: https://www.hellenicshippingnews.com/mmi-daily-iron-ore-index-report-march-24-2026
summary: 'Main

  in Chinese iron ore and steelmaking prices 24/03/2026

  Dalian iron ore futures strengthened during the morning session before paring gains
  in the afternoon.The most-traded I2605 contract setiled at 824 RMB per tonne, representing
  a 0.55% increase from the prior trading day. In the physical market, spot prices
  increased by approximately 2-5 RMB. Trading houses were relatively active in offering
  quotations; however, enquiries from steel mills were limited, and their procurement
  strategies remained cautious, resulting in moderate transaction volumes.'
themes:
- china
- brazil
- australia
...
- iron_ore
- bauxite
title: MMI Daily Iron Ore Index Report March 24 2026
vessel_classes:
- capesize
- panamax
---
...
Image reference: 2026-03-24_mmi-daily-iron-ore-index-report-march-24-2026_img2.jpg
Source: Metals Market Index (MMI)

## Linked asset: 2026-03-24_MMi-Daily-Iron-Ore-Report-for-24th-March-2026.pdf
Source asset: reports/hellenic/iron_ore/pdfs/2026-03-24_MMi-Daily-Iron-Ore-Report-for-24th-March-2026.pdf

[Page 1]
MMi Daily Iron Ore Index Report Mar 24th, 2026
MMi Dashboard
...
805 924 732
4 0.54% 3.81 0.41% 3 0.41%
Mar 24th, 2026 Mar 24th, 2026 Mar 24th, 2026
...
824.00 107.70 3145
5.00 0.61% -0.50 -0.46% -9 -0.29%
Mar 24th, 2026 (3pm close) Mar 24th, 2026 (5.30 pm Print) Mar 24th, 2026 (3pm close)
Freight Rates Steel Price
C3, Tubarao - Qingdao USD/t C5, W. Australia - Qingdao USD/t Steel Rebar (China Domestic) RMB/t
30.37 11.55 3154
-0.16 -0.5% -0.22 -1.9% -10 -0.32%
...
Page 1/6 Mar 24th, 2026

[Page 2]
MMi Daily Iron Ore Index Report Mar 24th, 2026
IRON ORE PORT STOCK INDEX (IOPI)
Mar 24th, 2026 FOT Qingdao (inc. 13% VAT), RMB/wet tonne CFR Qingdao Equivalent (exc. 13% VAT), USD/dry tonne ¹
Index Fe Content Price Change Change % MTD YTD Low ² High ² Price Change Change % MTD YTD Low ² High ²
IOPI62 62% Fe Fines 805 4 0.5% 787 828 683 1063 108.24 0.38 0.4% 102.63 108.09 89.33 140.24
IOPI58 58% Fe Fines 732 3 0.4% 694 727 610 963 99.11 0.22 0.2% 91.03 95.59 80.25 128.13
IOPI65 65% Fe Fines 924 4 0.4% 897 938 794 1175 124.76 0.27 0.2% 117.39 122.97 104.47 155.37
IRON ORE SEABORNE INDEX (IOSI) MARKET COMMENTARY
Mar 24th, 2026 CFR Qingdao, USD/dry tonne Dalian iron ore futures strengthened during the morning session before paring gains in the a(cid:332)ernoon. The most-traded I2605 contract se(cid:425)led at 824
RMB per tonne, represen(cid:415)ng a 0.55% increase from the prior trading day. In the physical market, spot prices increased by approximately 2-5 RMB.
Trading houses were rela(cid:415)vely ac(cid:415)ve in offering quota(cid:415)ons; however, enquiries from steel mills were limited, and their procurement strategies
Index Fe Content Price Change Change % MTD YTD Low 2 High 2 remained cau(cid:415)ous, resul(cid:415)ng in moderate transac(cid:415)on volumes. On a fundamental basis, the intensity of blast furnace maintenance has con(cid:415)nued to
decline this week. The volume of hot metal produc(cid:415)on affected by maintenance stood at 1.65 million tonnes, a week-on-week reduc(cid:415)on of 206,500
tonnes. This figure is projected to decrease by a further 180,000 tonnes next week to 1.4684 million tonnes, indica(cid:415)ng a progressive improvement on
IOSI62 62% Fe Fines 106.87 -0.13 -0.12% 103.52 109.05 89.79 142.65 the demand side. Concurrently, (cid:415)ght supply condi(cid:415)ons persist with no significant news of adjustments, which con(cid:415)nues to exert a bullish influence on
iron ore in the short term. Nevertheless, some capital is being held back due to concerns over future market risks, leading to a prevalent wait-and-see
IOSI65 65% Fe Fines 125.79 -0.17 -0.13% 115.77 123.69 98.23 171.65 sen(cid:415)ment. In summary, it is an(cid:415)cipated that iron ore prices will maintain a high-level consolida(cid:415)on pa(cid:425)ern in the near term.
...
IOPI62 62% Fe Fines 805 798 810 769 787 783 828 105.46 100.24 107.43 102.60 102.63 102.01 108.09
IOPI58 58% Fe Fines 720 716 719 699 694 689 727 95.02 94.72 96.04 93.94 91.03 90.35 95.59
IOPI65 65% Fe Fines 917 925 900 852 897 892 938 120.64 122.17 119.85 114.11 117.39 116.81 122.97
IRON ORE SEABORNE INDEX MONTHLY, QUARTERLY AND YEAR-TO-DATE AVERAGES FREIGHT RATES
Mar 24th, 2026 CFR Qingdao, USD/dry tonne Mar 23rd, 2026 FREIGHT RATES - DRY BULK US$/wet tonne
Index Fe Content NovemberDecember January February MTD QTD YTD Route Designation Change Change % Low 2 High 2
IOSI62 62% Fe Fines 106.33 105.42 106.27 99.65 103.52 102.86 109.05 W. Australia - Qingdao C5 11.55 -0.22 -1.9% 5.92 14.89
IOSI65 65% Fe Fines 122.46 121.09 121.51 118.61 115.77 114.95 123.69 Tubarao - Qingdao C3 30.37 -0.16 -0.5% 16.08 35.02
...
Mar 24th, 2026 PORT STOCK INDEX (RMB/WT) Mar 24th, 2026 SEABORNE INDEX (USD/DMT)
Index Fe Content Spread to IOPI62 % Spread to IOPI62 Index Fe Content Spread to IOSI62 % Spread to IOSI62
IOPI58 58% Fe Fines -73 -9.10%
IOPI65 65% Fe Fines 119 14.73% IOSI65 65% Fe Fines 18.92 17.70%
Page 2/6 Mar 24th, 2026
...
Roy Hill 766 3 -39 Roy Hill 99.70 -0.30 -7.17
SIMEC Fines 793 4 -12 SIMEC Fines 95.70 -0.30 -11.17
PB Fines 814 4 9 PB Fines 106.55 -0.45 -0.32
Newman Fines 811 4 6 Newman Fines 103.50 -0.50 -3.37
MAC Fines 805 4 0 MAC Fines 103.30 -0.50 -3.57
Jimblebar Blended Fines 723 4 -82 Jimblebar Blended Fines 95.90 -0.70 -10.97
Carajas Fines 897 4 92 Carajas Fines 125.40 -0.70 18.53
Brazilian SSF 879 5 74 Brazilian SSF 102.70 -0.40 -4.17
Brazilian Blend Fines 871 4 66 Brazilian Blend Fines 113.70 -0.60 6.83
RTX Fines 681 3 -124 RTX Fines 96.15 -0.65 -10.72
West Pilbara Fines 804 4 -1 West Pilbara Fines 98.30 -0.40 -8.57
Mar 24th, 2026 PORT STOCK INDEX (RMB/WT)
Price Change Diff to IOPI58
SSF 683 3 -49
FMG Blended Fines 743 2 11
Robe River 740 2 8
Western Fines 700 3 -32
Atlas Fines 745 2 13
Yandi 721 2 -11
...
High Fe Grade Si <4% 17.00 6.00 High Fe Grade Si <4% 2.25 0.00
...
0.01%
High Fe Grade 0.115%<P<0.15% 20.00 -5.00 Phosphorus High Fe Grade 0.115%<P<0.15% 1.75 0.00
Phosphorus
...
Qingdao 32.30 0.34% 22.28 34.83 Closing Price 824.00 5.00 0.61% 107.70 -0.50 -0.46%
Caofeidian 17.68 0.91% 7.56 20.28 Vol traded ('000 lots) 21.98 -4.35 -16.53% 7.45 -1.85 -19.85%
Tianjin 12.25 -2.16% 6.64 12.52 Open positions ('000 lots) 44.59 0.40 0.90% 48.27 -0.12 -0.24%
Rizhao 12.71 2.33% 11.52 21.35 Day Low 813.0 0.50 0.06% 107.15 -0.30 -0.28%
Total (35 Ports) 156.39 0.63% 105.01 166.39 Day High 829.5 3.50 0.42% 108.90 0.25 0.23%
60.00 130
50.00 120
40.00
110
...
Mar 24th, 2026 Specifications applied for 62% brand assessments Specifications applied for 62% brand assessments
...
Mar 24th, 2026 Specifications applied for 58% brand assessments
...
Page 6/6 Mar 24th, 2026
COPYRIGHT METALS MARKET INDEX, ALL RIGHTS RESERVED

## Linked asset: 2026-03-24_mmi-daily-iron-ore-index-report-march-24-2026_img2.jpg
Source asset: reports/hellenic/iron_ore/2026/2026-03-24_mmi-daily-iron-ore-index-report-march-24-2026_img2.jpg

Linked image asset: 2026-03-24_mmi-daily-iron-ore-index-report-march-24-2026_img2.jpg
...
Index Fe Content Price Change Change% MTD YTD Low? High? Price Change Change% MTD YTD Low? High?
lOPI62 | 62%FeFines| 805 4 0.5% 787 828 683 1063 | 108.24 = 0.38 0.4% 102.63 108.09 89.33 140.24
1OPIS8 | 58%FeFines| 732 3 0.4% 694 727 610 963 99.11 0.22 0.2% 91.03 95.59 80.25 128.13
lOPIGS | 65%FeFines| 924 4 0.4% 897 938 794 1175 | 124.76 = 0.27 0.2% 117.39 122.97 104.47 155.37
IRON ORE SEABORNE INDEX (IOS!) MARKET COMMENTARY
CFR Qingdao, USD/dry tonne non enn nn mar nr prea re. eed 3c ng
Teshag Saat was rastoor nce mang fovecoan Sooner: tapas Reales one and sok ak oom a
Index FeContent | Price Change Change % MTD YTD Low* High? meen ese manta fmamsenence ned S345 mon wanah 2 west mene 500
1osi62 62% FeFines| 106.87 0.13 0.12% 103.52 109.05 89.79 142.65, || sscunsasusa concorency he spy canons prs wan co ruc eaua of oamana wth cones to eet tulan aces ct
(oncre tn tw shat ne herria, ste apt eng bth Soe cones ov hone sae ke aang lo prevaeel waren ee
foaes cence ries | 4g579\schag- Monee /11S97)- 19360). Nonosi_capsies aries pitanaary nv nacocamcanesan saniemaasanciapion mamatantemneas cares
IRON ORE PORT LUMP INDEX (IOPLI)
FOT Qingdao (inc. 13% VAT), RMB/wet tonne CFR Qingdao Equivalent (exc. 13% VAT), USD/dry tonne 2
Index FeContent | Price | W-o-W Change% MTD YTD Low? High? Price W-owW Change% MTD YTD Low? High?
IOPLIG2 | 625%FeWwmp | 900 -10 "1.1% 895 952 820 1210 | 116.57 -1.26 © -1.07% += 112.25 119.67 102.77 153.57
